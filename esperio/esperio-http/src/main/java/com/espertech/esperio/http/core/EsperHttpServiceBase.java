...
public abstract class EsperHttpServiceBase {
    ...
    public abstract void start(EPRuntimeSPI runtime) throws IOException;

    public abstract void destroy();

    protected HttpRequestHandlerRegistry setupRegistry(EPRuntimeSPI runtime) {
        ...
        for (GetHandler getHandler : getHandlers) {
            ...
            registery.register(getHandler.getPattern(), new EsperHttpRequestHandler(runtime));
        }
        return registery;
    }
