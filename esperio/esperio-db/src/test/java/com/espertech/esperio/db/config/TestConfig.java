...
public class TestConfig extends TestCase {
    ...
    protected static void assertFileConfig(ConfigurationDBAdapter config) throws Exception {
        ...
        ConfigurationCommonDBRef connection = config.getJdbcConnections().get("db1");
        ConfigurationCommonDBRef.DataSourceConnection dsDef = (ConfigurationCommonDBRef.DataSourceConnection) connection.getConnectionFactoryDesc();
        ...
        ConfigurationCommonDBRef.DataSourceFactory dsFactory = (ConfigurationCommonDBRef.DataSourceFactory) connection.getConnectionFactoryDesc();
        ...
        ConfigurationCommonDBRef.DriverManagerConnection dmDef = (ConfigurationCommonDBRef.DriverManagerConnection) connection.getConnectionFactoryDesc();
