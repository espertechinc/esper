...
public class EsperSocketService {
    ...
    public void start(String serviceName, EPRuntimeSPI runtime) throws IOException {
        ...
        runnable = new EsperSocketServiceRunnable(this.getServiceName(), this.serviceConfig, serverSocket, runtime);
