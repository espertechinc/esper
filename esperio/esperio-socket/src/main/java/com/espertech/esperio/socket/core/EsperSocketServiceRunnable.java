...
public class EsperSocketServiceRunnable implements Runnable {
    ...
    public EsperSocketServiceRunnable(String serviceName, SocketConfig serviceConfig, ServerSocket serversocket, EPRuntimeSPI runtime) {
    ...
    public void run() {
        ...
        while (!Thread.interrupted()) {
            try {
                ...
                // Start worker thread
                WorkerThread t = new WorkerThread(serviceName, runtime, this, socket, serviceConfig);
                t.setDaemon(true);
                t.start();
                workers.add(t);
