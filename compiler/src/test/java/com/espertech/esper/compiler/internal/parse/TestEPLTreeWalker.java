...
public class TestEPLTreeWalker extends TestCase {
    ...
    public void testWalkCreateIndex() throws Exception {
        ...
        assertEquals("c", ExprNodeUtilityPrint.toExpressionStringMinPrecedenceSafe(createIndex.getColumns().get(0).getExpressions().get(0)));
        assertEquals(CreateIndexType.HASH.getNameLower(), createIndex.getColumns().get(0).getType());
        assertEquals("d", ExprNodeUtilityPrint.toExpressionStringMinPrecedenceSafe(createIndex.getColumns().get(1).getExpressions().get(0)));
    ...
    public void testWalkOnUpdate() throws Exception {
        ...
        assertEquals("a=b", ExprNodeUtilityPrint.toExpressionStringMinPrecedenceSafe(raw.getWhereClause()));
    }
    ...
    public void testWalkOnSelectNoInsert() throws Exception {
        ...
        assertTrue(raw.getWhereClause() instanceof ExprEqualsNode);
    }
    ...
    public void testWalkOnSelectInsert() throws Exception {
        ...
        assertTrue(streamSpec.getEvalForgeNode() instanceof EvalFilterForgeNode);
        ...
        assertTrue(raw.getHavingClause() instanceof ExprEqualsNode);
    ...
    public void testWalkOnSelectMultiInsert() throws Exception {
        ...
        assertNotNull((ExprRelationalOpNode) raw.getWhereClause());
    ...
    public void testWalkOnDelete() throws Exception {
        ...
        assertTrue(patternSpec.getEvalForgeNode() instanceof EvalEveryForgeNode);
    }
    ...
    public void testWalkMatchRecognize() throws Exception {
        ...
        for (int i = 0; i < patternTests.length; i++) {
            ...
            raw.getMatchRecognizeSpec().getPattern().toEPL(writer, RowRecogExprNodePrecedenceEnum.MINIMUM);
    ...
    public void testWalkPatternMatchUntil() throws Exception {
        EPLTreeWalkerListener walker = SupportParserHelper.parseAndWalkEPL("select * from pattern[A until (B or C)]");
        StatementSpecRaw raw = walker.getStatementSpec();
        PatternStreamSpecRaw a = (PatternStreamSpecRaw) raw.getStreamSpecs().get(0);
        EvalMatchUntilForgeNode matchNode = (EvalMatchUntilForgeNode) a.getEvalForgeNode();
        assertEquals(2, matchNode.getChildNodes().size());
        assertTrue(matchNode.getChildNodes().get(0) instanceof EvalFilterForgeNode);
        assertTrue(matchNode.getChildNodes().get(1) instanceof EvalOrForgeNode);

        EvalMatchUntilForgeNode spec = getMatchUntilSpec("A until (B or C)");
    ...
    private EvalMatchUntilForgeNode getMatchUntilSpec(String text) throws Exception {
        EPLTreeWalkerListener walker = SupportParserHelper.parseAndWalkEPL("select * from pattern[" + text + "]");
        StatementSpecRaw raw = walker.getStatementSpec();
        PatternStreamSpecRaw a = (PatternStreamSpecRaw) raw.getStreamSpecs().get(0);
        return (EvalMatchUntilForgeNode) a.getEvalForgeNode();
    }
    ...
    public void testWalkSimpleWhere() throws Exception {
        ...
        assertTrue(walker.getStatementSpec().getWhereClause() instanceof ExprEqualsNode);
        ExprNode equalsNode = (walker.getStatementSpec().getWhereClause());
    ...
    public void testWalkWhereWithAnd() throws Exception {
        ...
        // Join expression tree validation
        assertTrue(walker.getStatementSpec().getWhereClause() instanceof ExprAndNode);
        assertEquals(2, walker.getStatementSpec().getWhereClause().getChildNodes().length);
        ExprNode equalsNode = (walker.getStatementSpec().getWhereClause().getChildNodes()[0]);
        assertEquals(2, equalsNode.getChildNodes().length);
        ...
        equalsNode = (walker.getStatementSpec().getWhereClause().getChildNodes()[1]);
    ...
    public void testWalkView() throws Exception {
        ...
        assertEquals(10, ((ExprConstantNode) specOne.getObjectParameters().get(0)).getConstantValue());
        assertEquals(1.1d, ((ExprConstantNode) specOne.getObjectParameters().get(1)).getConstantValue());
        assertEquals("a", ((ExprConstantNode) specOne.getObjectParameters().get(2)).getConstantValue());
        ...
        assertEquals(false, ((ExprConstantNode) specTwo.getObjectParameters().get(1)).getConstantValue());
    }
    ...
    public void testWalkPropertyExpr() throws Exception {
        ...
        assertEquals("a.b", ExprNodeUtilityPrint.toExpressionStringMinPrecedenceSafe(filterSpec.getOptionalPropertyEvalSpec().getAtoms().get(0).getSplitterExpression()));
        ...
        assertEquals("e", ExprNodeUtilityPrint.toExpressionStringMinPrecedenceSafe(atomTwo.getSplitterExpression()));
    ...
    public void testHaving() throws Exception {
        ...
        ExprNode havingNode = walker.getStatementSpec().getHavingClause();
        ...
        havingNode = walker.getStatementSpec().getHavingClause();
        assertTrue(havingNode instanceof ExprRelationalOpNode);
    }
    ...
    public void testComplexProperty() throws Exception {
        ...
        identNode = (ExprIdentNode) walker.getStatementSpec().getWhereClause().getChildNodes()[0];
    ...
    public void testPatternsOnly() throws Exception {
        ...
        assertEquals(EvalFollowedByForgeNode.class, patternStreamSpec.getEvalForgeNode().getClass());
        ...
        assertEquals(EvalOrForgeNode.class, patternStreamSpec.getEvalForgeNode().getClass());
    ...
    public void testOnMerge() throws Exception {
        ...
        assertTrue(spec.getWhereClause() instanceof ExprInNode);
    ...
    public void testWalkPattern() throws Exception {
        ...
        EvalForgeNode rootNode = patternStreamSpec.getEvalForgeNode();

        EvalEveryForgeNode everyNode = (EvalEveryForgeNode) rootNode;

        assertTrue(everyNode.getChildNodes().get(0) instanceof EvalGuardForgeNode);
        EvalGuardForgeNode guardNode = (EvalGuardForgeNode) everyNode.getChildNodes().get(0);

        assertEquals(1, guardNode.getChildNodes().size());
        assertTrue(guardNode.getChildNodes().get(0) instanceof EvalFilterForgeNode);
        EvalFilterForgeNode filterNode = (EvalFilterForgeNode) guardNode.getChildNodes().get(0);
    ...
    public void testWalkPatternUseResult() throws Exception {
        ...
        SupportParserHelper.parseAndWalkEPL("select * from pattern[" + text + "]");
    }
    ...
    public void testSubselect() throws Exception {
        ...
        // check where clause
        assertTrue(spec.getWhereClause() instanceof ExprEqualsNode);
    }
    ...
    private String tryWalkGetPropertyPattern(String stmt) throws Exception {
        EPLTreeWalkerListener walker = SupportParserHelper.parseAndWalkEPL("select * from pattern[" + stmt + "]");

        assertEquals(1, walker.getStatementSpec().getStreamSpecs().size());
        PatternStreamSpecRaw patternStreamSpec = (PatternStreamSpecRaw) walker.getStatementSpec().getStreamSpecs().get(0);

        EvalFilterForgeNode filterNode = (EvalFilterForgeNode) patternStreamSpec.getEvalForgeNode();
    ...
    private Object tryBitWise(String equation) throws Exception {
        ...
        EPLTreeWalkerListener walker = SupportParserHelper.parseAndWalkEPL(expression);
        ExprNode exprNode = walker.getStatementSpec().getWhereClause().getChildNodes()[0];
        ExprBitWiseNode bitWiseNode = (ExprBitWiseNode) (exprNode);
        ExprNodeUtilityValidate.getValidatedSubtree(ExprNodeOrigin.SELECT, bitWiseNode, SupportExprValidationContextFactory.makeEmpty());
    ...
    private Object tryExpression(String equation) throws Exception {
        ...
        EPLTreeWalkerListener walker = SupportParserHelper.parseAndWalkEPL(expression);
        ExprNode exprNode = (walker.getStatementSpec().getWhereClause().getChildNodes()[0]);
        exprNode = ExprNodeUtilityValidate.getValidatedSubtree(ExprNodeOrigin.SELECT, exprNode, SupportExprValidationContextFactory.makeEmpty());
    ...
    private Object tryRelationalOp(String subExpr) throws Exception {
        ...
        EPLTreeWalkerListener walker = SupportParserHelper.parseAndWalkEPL(expression);
        ExprNode filterExprNode = walker.getStatementSpec().getWhereClause();
        ExprNodeUtilityValidate.getValidatedSubtree(ExprNodeOrigin.SELECT, filterExprNode, SupportExprValidationContextFactory.makeEmpty());
