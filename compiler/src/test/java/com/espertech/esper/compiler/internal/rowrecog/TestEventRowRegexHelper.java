 ...
 ***************************************************************************************
 */
package com.espertech.esper.compiler.internal.rowrecog;
...
import com.espertech.esper.compiler.internal.parse.SupportStatementSpecMapEnv;
...
public class TestEventRowRegexHelper extends TestCase {
    public void testVariableAnalysis() throws Exception {
        ...
        for (int i = 0; i < patternTests.length; i++) {
            ...
            StatementSpecRaw raw = CompilerHelperSingleEPL.parseWalk(expression, SupportStatementSpecMapEnv.make());

            RowRecogExprNode parent = raw.getMatchRecognizeSpec().getPattern();
    ...
    public void testVisibilityAnalysis() throws Exception {
        ...
        for (int i = 0; i < patternTests.length; i++) {
            ...
            Map<String, Set<String>> visibility = RowRecogHelper.determineVisibility(parent);
