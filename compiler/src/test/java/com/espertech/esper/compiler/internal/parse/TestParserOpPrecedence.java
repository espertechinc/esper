...
public class TestParserOpPrecedence extends TestCase {
    ...
    private void assertEquivalent(String expressionOne, String expressionTwo) throws Exception {
        EPLTreeWalkerListener l1 = SupportParserHelper.parseAndWalkEPL("select * from pattern[" + expressionOne + "]");
        EPLTreeWalkerListener l2 = SupportParserHelper.parseAndWalkEPL("select * from pattern[" + expressionTwo + "]");
    ...
    private String toPatternText(EPLTreeWalkerListener walker) {
        ...
        raw.getEvalForgeNode().toEPL(writer, PatternExpressionPrecedenceEnum.MINIMUM);
