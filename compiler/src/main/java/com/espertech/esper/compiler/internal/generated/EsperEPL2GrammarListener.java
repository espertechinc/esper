...
public interface EsperEPL2GrammarListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link EsperEPL2GrammarParser#unaryMinus}.
	 * @param ctx the parse tree
	 */
	void enterUnaryMinus(EsperEPL2GrammarParser.UnaryMinusContext ctx);
	/**
	 * Exit a parse tree produced by {@link EsperEPL2GrammarParser#unaryMinus}.
	 * @param ctx the parse tree
	 */
	void exitUnaryMinus(EsperEPL2GrammarParser.UnaryMinusContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterClassIdentifierWithDimensions(EsperEPL2GrammarParser.ClassIdentifierWithDimensionsContext ctx);
	/**
	 * Exit a parse tree produced by {@link EsperEPL2GrammarParser#classIdentifierWithDimensions}.
	 * @param ctx the parse tree
	 */
	 ...
	 * @param ctx the parse tree
	 */
	void enterDimensions(EsperEPL2GrammarParser.DimensionsContext ctx);
	/**
	 * Exit a parse tree produced by {@link EsperEPL2GrammarParser#dimensions}.
	 * @param ctx the parse tree
	 */
	void exitDimensions(EsperEPL2GrammarParser.DimensionsContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link EsperEPL2GrammarParser#substitutionSlashIdent}.
	 * @param ctx the parse tree
	 */
	void enterSubstitutionSlashIdent(EsperEPL2GrammarParser.SubstitutionSlashIdentContext ctx);
	/**
	 * Exit a parse tree produced by {@link EsperEPL2GrammarParser#substitutionSlashIdent}.
	 * @param ctx the parse tree
	 */
	void exitSubstitutionSlashIdent(EsperEPL2GrammarParser.SubstitutionSlashIdentContext ctx);
	/**
