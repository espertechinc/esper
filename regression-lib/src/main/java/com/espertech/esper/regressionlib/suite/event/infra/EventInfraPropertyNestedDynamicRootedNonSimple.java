...
public class EventInfraPropertyNestedDynamicRootedNonSimple implements RegressionExecution {
    public final static String XML_TYPENAME = EventInfraPropertyNestedDynamicRootedNonSimple.class.getSimpleName() + "XML";
    public final static String MAP_TYPENAME = EventInfraPropertyNestedDynamicRootedNonSimple.class.getSimpleName() + "Map";
    public final static String OA_TYPENAME = EventInfraPropertyNestedDynamicRootedNonSimple.class.getSimpleName() + "OA";
