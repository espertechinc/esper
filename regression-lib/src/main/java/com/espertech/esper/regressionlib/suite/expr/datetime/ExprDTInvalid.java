...
public class ExprDTInvalid implements RegressionExecution {
    ...
    public void run(RegressionEnvironment env) {
        ...
        tryInvalidCompile(env, epl, "Failed to validate select-clause expression 'utildate.between(utildate,utildate,...(42 chars)': Failed to validate date-time method 'between', expected a boolean-type result for expression parameter 2 but received int");
