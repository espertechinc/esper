...
import com.espertech.esper.regressionlib.support.bean.SupportBean_S2;
...
public class EPLOuterJoinVarB3Stream {
    ...
    private static void tryAssertion(RegressionEnvironment env, AtomicInteger milestone) {
        ...
        sendEvent(env, s0Events);
        EPAssertionUtil.assertEqualsAnyOrder(new Object[][]{{s0Events[0], null, s2Events[0]}}, getAndResetNewEvents(env));
        ...
        sendEvent(env, s0Events);
        EPAssertionUtil.assertEqualsAnyOrder(new Object[][]{{s0Events[0], s1Events[0], s2Events[0]}}, getAndResetNewEvents(env));
        ...
        sendEvent(env, s2Events);
        EPAssertionUtil.assertEqualsAnyOrder(new Object[][]{
            {s0Events[0], null, s2Events[0]}}, getAndResetNewEvents(env));
        ...
        EPAssertionUtil.assertEqualsAnyOrder(new Object[][]{
            {s0Events[0], null, s2Events[0]},
            {s0Events[1], null, s2Events[0]}}, getAndResetNewEvents(env));
