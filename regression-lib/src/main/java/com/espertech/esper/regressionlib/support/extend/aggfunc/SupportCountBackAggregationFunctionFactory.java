...
public class SupportCountBackAggregationFunctionFactory implements AggregationFunctionFactory {
    public final static EPTypeClass EPTYPE = new EPTypeClass(SupportCountBackAggregationFunctionFactory.class);
