...
public class SupportReferenceCountedMapAccessorFactory implements AggregationMultiFunctionAccessorFactory {
    public final static EPTypeClass EPTYPE = new EPTypeClass(SupportReferenceCountedMapAccessorFactory.class);
