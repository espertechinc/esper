...
public class SupportInvalidAggregationFunctionForge implements AggregationFunctionForge {
    ...
    public AggregationFunctionMode getAggregationFunctionMode() {
        return new AggregationFunctionModeMultiParam().setInjectionStrategyAggregationFunctionFactory(new InjectionStrategyClassNewInstance(SupportInvalidAggregationFunctionFactory.class));
    }
}
