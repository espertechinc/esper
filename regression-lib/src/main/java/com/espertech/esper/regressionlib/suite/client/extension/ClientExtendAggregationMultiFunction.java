...
public class ClientExtendAggregationMultiFunction implements RegressionExecution {
    ...
    private void sendAssertList(RegressionEnvironment env, SupportBean... events) {
    ...
    private void assertList(SupportListener listener, SupportBean... events) {
