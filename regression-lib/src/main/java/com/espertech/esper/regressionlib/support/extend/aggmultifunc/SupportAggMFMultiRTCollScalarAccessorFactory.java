...
public class SupportAggMFMultiRTCollScalarAccessorFactory implements AggregationMultiFunctionAccessorFactory {
    public final static EPTypeClass EPTYPE = new EPTypeClass(SupportAggMFMultiRTCollScalarAccessorFactory.class);
