...
import com.espertech.esper.regressionlib.support.rowrecog.SupportTestCaseHolder;
import com.espertech.esper.regressionlib.support.rowrecog.SupportTestCaseItem;
...
public class RowRecogRegex implements RegressionExecution {
    private static final Logger log = LoggerFactory.getLogger(RowRecogRegex.class);
    ...
    private void run(SupportTestCaseHolder testDesc, RegressionEnvironment env) {
        StringBuilder buf = new StringBuilder();
        buf.append("@name('s0') select * from SupportRecogBean#keepall " +
            "match_recognize (\n" +
            "  measures ");
        ...
        EPCompiled compiled = env.compile(buf.toString());
