...
public class ResultSetQueryTypeLocalGroupBy {
    ...
    public static class ResultSetLocalUngroupedSumSimple implements RegressionExecution {
        public void run(RegressionEnvironment env) {
            ...
            env.assertPropsNew("s0", fields, new Object[]{10 + 13L, 10 + 12 + 13L, 10 + 13L, 10 + 11 + 12 + 13L});

            makeSendEvent(env, "E2", 1, 14);
            env.assertPropsNew("s0", fields, new Object[]{14L, 11 + 14L, 10 + 13 + 14L, 10 + 11 + 12 + 13 + 14L});
    ...
    private static class ResultSetLocalInvalid implements RegressionExecution {
        public void run(RegressionEnvironment env) {
            ...
            env.tryInvalidCompile("create table MyTable(approx countMinSketch(group_by:theString) @type(SupportBean))",
            ...
            env.tryInvalidCompile("create table MyTable(col sum(int, group_by:theString) @type(SupportBean))",
            ...
            env.tryInvalidCompile("select sum(intPrimitive, xxx:theString) from SupportBean",
            ...
            env.tryInvalidCompile("select sum(intPrimitive, group_by:sum(intPrimitive)) from SupportBean",
            ...
            env.tryInvalidCompile("select coalesce(0, 1, group_by:theString) from SupportBean",
                "Failed to validate select-clause expression 'coalesce(0,1,group_by:theString)': Named parameters are not allowed");
            env.tryInvalidCompile("select " + SupportStaticMethodLib.class.getName() + ".staticMethod(group_by:intPrimitive) from SupportBean",
            ...
            env.tryInvalidCompile("select sum(intPrimitive, group_by:theString) from SupportBean group by rollup(theString)",
            ...
            env.tryInvalidCompile(eplMatchRecog,
    ...
    public static class ResultSetLocalUngroupedAggEvent implements RegressionExecution {
        public void run(RegressionEnvironment env) {
            ...
            env.assertPropsNew("s0", cols, new Object[]{b1, b1, b1, b1, new Object[]{b1}, new Object[]{b1},
                b1, b1, b1, b1, new Object[]{b1}, new Object[]{b1}, b1, b1, b1, b1,
                b1, b1, b1, b1});

            SupportBean b2 = makeSendEvent(env, "E2", 20);
            env.assertPropsNew("s0", cols, new Object[]{b2, b1, b2, b2, new Object[]{b2}, new Object[]{b1, b2},
                b2, b2, b2, b1, new Object[]{b2}, new Object[]{b1, b2}, b2, b2, b2, b1,
                b2, b1, b2, b2});

            SupportBean b3 = makeSendEvent(env, "E1", 15);
            env.assertPropsNew("s0", cols, new Object[]{b1, b1, b3, b3, new Object[]{b1, b3}, new Object[]{b1, b2, b3},
                b3, b2, b1, b1, new Object[]{b1, b3}, new Object[]{b1, b3, b2}, b3, b2, b1, b1,
                b1, b1, b3, b3});

            SupportBean b4 = makeSendEvent(env, "E3", 16);
            env.assertPropsNew("s0", cols, new Object[]{b4, b2, b4, b4, new Object[]{b4}, new Object[]{b2, b3, b4},
    ...
    public static class ResultSetLocalUngroupedAggSQLStandard implements RegressionExecution {
        public void run(RegressionEnvironment env) {
            ...
            env.assertPropsNew("s0", fields, new Object[]{10, 10, 10,
                0.0d, 10d, 10, 10, 10, 10, 10, 10, 10, 10, 10.0, 0L});

            env.sendEventBean(new SupportBean("E2", 20));
            env.assertPropsNew("s0", fields, new Object[]{20, 10 + 20, 20,
                0.0d, 20d, 20, 20, 20, 20, 20, 20, 20, 20, 20.0, 0L});

            env.sendEventBean(new SupportBean("E1", 30));
            env.assertPropsNew("s0", fields, new Object[]{30, 10 + 20 + 30, 10 + 30,
    ...
    public static class ResultSetLocalUngroupedOrderBy implements RegressionExecution {
        public void run(RegressionEnvironment env) {
            ...
            env.assertPropsPerRowLastNew("s0", "theString,c0".split(","), new Object[][]{
    ...
    public static class ResultSetLocalEnumMethods implements RegressionExecution {
        ...
        public void run(RegressionEnvironment env) {
            ...
            SupportBean b1 = makeSendEvent(env, "E1", 10);
            env.assertPropsNew("s0", "c0,c1,c2,c3,c4,c5".split(","),
