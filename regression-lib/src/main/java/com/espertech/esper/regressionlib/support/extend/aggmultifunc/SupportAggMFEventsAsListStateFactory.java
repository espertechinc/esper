...
public class SupportAggMFEventsAsListStateFactory implements AggregationMultiFunctionStateFactory {
    public final static EPTypeClass EPTYPE = new EPTypeClass(SupportAggMFEventsAsListStateFactory.class);
