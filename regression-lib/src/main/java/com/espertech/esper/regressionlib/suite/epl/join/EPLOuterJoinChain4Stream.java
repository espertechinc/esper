...
public class EPLOuterJoinChain4Stream {
    ...
    private static class EPLJoinLeftOuterJoinRootS1 implements RegressionExecution {
        public void run(RegressionEnvironment env) {
            /**
             * Query:
             *          s0
    ...
    private static class EPLJoinLeftOuterJoinRootS2 implements RegressionExecution {
        public void run(RegressionEnvironment env) {
            /**
             * Query:
             *          s0
    ...
    private static class EPLJoinLeftOuterJoinRootS3 implements RegressionExecution {
        public void run(RegressionEnvironment env) {
            /**
             * Query:
             *          s0
    ...
    private static void tryAssertion(RegressionEnvironment env) {
        ...
        sendEvent(env, s0Events);
        assertListenerUnd(env, 
            new Object[][]{{s0Events[0], s1Events[0], null, null}});
        ...
        assertListenerUnd(env, new Object[][]{
            ...
            {s0Events[0], s1Events[1], s2Events[1], null}});
        ...
        assertListenerUnd(env, new Object[][]{
            ...
            {s0Events[0], s1Events[1], s2Events[1], s3Events[1]}});
        ...
        assertListenerUnd(env, new Object[][]{
            {s0Events[0], s1Events[0], s2Events[0], s3Events[0]},
            {s0Events[0], s1Events[0], s2Events[0], s3Events[1]},
            {s0Events[0], s1Events[0], s2Events[0], s3Events[2]}});
        ...
        assertListenerUnd(env, new Object[][]{
            ...
            {s0Events[1], s1Events[1], s2Events[2], s3Events[0]}});
        ...
        assertListenerUnd(env, new Object[][]{
            ...
            {s0Events[0], s1Events[1], s2Events[0], null},
            {s0Events[1], s1Events[0], s2Events[0], null},
            {s0Events[1], s1Events[1], s2Events[0], null}});
        ...
        assertListenerUnd(env, new Object[][]{
            ...
            {s0Events[0], s1Events[1], s2Events[0], s3Events[1]},
            {s0Events[1], s1Events[0], s2Events[0], s3Events[1]},
            {s0Events[1], s1Events[1], s2Events[0], s3Events[1]}});
    ...
    private static void assertListenerUnd(RegressionEnvironment env, Object[][] expected) {
        env.assertListener("s0", listener -> {
            Object[][] und = ArrayHandlingUtil.getUnderlyingEvents(listener.getAndResetLastNewData(), new String[]{"s0", "s1", "s2", "s3"});
