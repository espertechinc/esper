...
public class SupportAggMFMultiRTEnumerableEventsAccessorFactory implements AggregationMultiFunctionAccessorFactory {
    public final static EPTypeClass EPTYPE = new EPTypeClass(SupportAggMFMultiRTEnumerableEventsAccessorFactory.class);
