...
public class SupportLowerUpperCompareAggregationFunctionForge implements AggregationFunctionForge {
    private static List<AggregationFunctionValidationContext> contexts = new ArrayList<AggregationFunctionValidationContext>();

    public static List<AggregationFunctionValidationContext> getContexts() {
        return contexts;
    }
