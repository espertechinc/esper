...
public class ClientRuntimeSubscriber implements RegressionExecution {
    ...
    private void tryAssertionJustWildcard(RegressionEnvironment env, EPStatement stmt, SupportSubscriberRowByRowSpecificBase subscriber) {
    ...
    private void tryAssertionBindUpdateIRStream(RegressionEnvironment env, SupportSubscriberRowByRowFullBase subscriber) {
    ...
    private void tryAssertionBindObjectArr(RegressionEnvironment env, EventRepresentationChoice eventRepresentationEnum, SupportSubscriberMultirowObjectArrayBase subscriber) {
    ...
    private void tryAssertionBindMap(RegressionEnvironment env, EventRepresentationChoice eventRepresentationEnum, SupportSubscriberMultirowMapBase subscriber) {
        String stmtText = eventRepresentationEnum.getAnnotationText() + " @name('s0') select irstream theString, intPrimitive from SupportBean" + "#length_batch(2)";
        EPStatement stmt = env.compileDeploy(stmtText).statement("s0");
        stmt.setSubscriber(subscriber);
        assertTrue(eventRepresentationEnum.matchesClass(stmt.getEventType().getUnderlyingType()));
    ...
    private void tryAssertionWidening(RegressionEnvironment env, EventRepresentationChoice eventRepresentationEnum, SupportSubscriberRowByRowSpecificBase subscriber) {
    ...
    private void tryAssertionObjectArrayDelivery(RegressionEnvironment env, EventRepresentationChoice eventRepresentationEnum, SupportSubscriberRowByRowObjectArrayBase subscriber) {
    ...
    private void tryAssertionRowMapDelivery(RegressionEnvironment env, EventRepresentationChoice eventRepresentationEnum, SupportSubscriberRowByRowMapBase subscriber) {
    ...
    private void tryAssertionNested(RegressionEnvironment env, EPStatement stmt, SupportSubscriberRowByRowSpecificBase subscriber) {
        stmt.setSubscriber(subscriber);
    ...
    private void tryAssertionEnum(RegressionEnvironment env, EPStatement stmtEnum, SupportSubscriberRowByRowSpecificBase subscriber) {
    ...
    private void tryAssertionNullSelected(RegressionEnvironment env, EPStatement stmt, SupportSubscriberRowByRowSpecificBase subscriber) {
        stmt.setSubscriber(subscriber);
        env.sendEventBean(new SupportBean());
        subscriber.assertOneReceivedAndReset(stmt, new Object[]{null, null});
    }

    private void tryAssertionStreamSelectWJoin(RegressionEnvironment env, SupportSubscriberRowByRowSpecificBase subscriber) {
    ...
    private void tryAssertionBindWildcardJoin(RegressionEnvironment env, SupportSubscriberRowByRowSpecificBase subscriber) {
    ...
    private void tryAssertionStreamWildcardJoin(RegressionEnvironment env, SupportSubscriberRowByRowSpecificBase subscriber) {
    ...
    private void tryAssertionOutputLimitNoJoin(RegressionEnvironment env, EventRepresentationChoice eventRepresentationEnum, SupportSubscriberRowByRowSpecificBase subscriber) {
    ...
    private void tryAssertionOutputLimitJoin(RegressionEnvironment env, SupportSubscriberRowByRowSpecificBase subscriber) {
    ...
    private void tryAssertionRStreamSelect(RegressionEnvironment env, SupportSubscriberRowByRowSpecificBase subscriber) {
    ...
    private void tryAssertionBindWildcardIRStream(RegressionEnvironment env, SupportSubscriberMultirowUnderlyingBase subscriber) {
    ...
    private void tryAssertionNoParams(RegressionEnvironment env, EPStatement stmt, SupportSubscriberNoParamsBase subscriber) {
        stmt.setSubscriber(subscriber);
    ...
    private void tryAsserionNamedMethod(RegressionEnvironment env, EPStatement stmt, SupportSubscriberMultirowUnderlyingBase subscriber) {
    ...
    private void tryAssertionNamedWindow(RegressionEnvironment env, EventRepresentationChoice eventRepresentationEnum) {
