...
public class SupportAggMFMultiRTSingleEventAccessorFactory implements AggregationMultiFunctionAccessorFactory {
    public final static EPTypeClass EPTYPE = new EPTypeClass(SupportAggMFMultiRTSingleEventAccessorFactory.class);
