...
public class ContextNested {
    ...
    private static class ContextNestedInitWStartNow implements RegressionExecution {
        public void run(RegressionEnvironment env) {
            ...
            env.assertPropsNew("s0", "c0,event,cnt".split(","), new Object[]{criteriaA, s0, 1L});

            env.sendEventBean(new SupportBean_S0(3, "A"));
            env.assertPropsNew("s0", "c0,cnt".split(","), new Object[]{criteriaA, 2L});
            ...
            env.assertPropsNew("s0", "c0,cnt".split(","), new Object[]{criteriaA, 1L});
    ...
    public static class ContextNestedInitWStartNowSceneTwo implements RegressionExecution {
        public void run(RegressionEnvironment env) {
            ...
            env.assertPropsNew("s0", "cnt".split(","), new Object[]{1L});
            ...
            env.assertPropsNew("s0", "cnt".split(","), new Object[]{2L});
    ...
    private static class ContextNestedPartitionedOverPatternInitiated implements RegressionExecution {
        public void run(RegressionEnvironment env) {
            ...
            env.assertPropsNew("s0", "theString,theSum".split(","), new Object[]{"C", -1L});

            env.milestone(2);

            sendSupportBean(env, "D", 2, 5);
            env.assertPropsNew("s0", "theString,theSum".split(","), new Object[]{"D", 9L});
    ...
    private static class ContextNestedIterateTargetedCP implements RegressionExecution {
        public void run(RegressionEnvironment env) {
            ...
            env.assertStatement("s0", statement -> {
                ...
                EPAssertionUtil.assertPropsPerRowAnyOrder(statement.iterator(ContextPartitionSelectorAll.INSTANCE), statement.safeIterator(ContextPartitionSelectorAll.INSTANCE), fields, expectedAll);
                SupportSelectorById allIds = new SupportSelectorById(new HashSet<>(Arrays.asList(0, 1, 2, 3, 4, 5)));
                EPAssertionUtil.assertPropsPerRowAnyOrder(statement.iterator(allIds), statement.safeIterator(allIds), fields, expectedAll);
                ...
                EPAssertionUtil.assertPropsPerRowAnyOrder(statement.iterator(nestedSelector), statement.safeIterator(nestedSelector), fields, new Object[][]{{"S0_2", "grp3", "E1", 2}});
                ...
                EPAssertionUtil.assertPropsPerRowAnyOrder(statement.iterator(nestedSelectorTwo), statement.safeIterator(nestedSelectorTwo), fields, new Object[][]{{"S0_2", "grp3", "E1", 2}, {"S0_1", "grp1", "E2", -1}});
            ...
            env.assertStatement("StmtOne", statement -> {
                EPAssertionUtil.assertPropsPerRowAnyOrder(statement.iterator(), statement.safeIterator(), fieldsSelect, expectedRows);
                EPAssertionUtil.assertPropsPerRowAnyOrder(statement.iterator(ContextPartitionSelectorAll.INSTANCE), statement.safeIterator(ContextPartitionSelectorAll.INSTANCE), fields, expectedRows);
            });
            ...
            env.assertStatement("StmtOne", statement -> EPAssertionUtil.assertPropsPerRowAnyOrder(statement.iterator(nestedSelectorSelect), statement.safeIterator(nestedSelectorSelect), fieldsSelect, new Object[][]{{"i3", "l1", "b2", 1L}}));
    ...
    private static class ContextNestedIterator implements RegressionExecution {
        public void run(RegressionEnvironment env) {
            ...
            env.sendEventBean(new SupportBean("E1", 1));
            final Object[][] expectedOne = new Object[][]{{DateTime.parseDefaultMSec("2002-05-1T08:00:00.000"), "E1", 1}};
            env.assertPropsPerRowLastNew("s0", fields, expectedOne);
            env.assertPropsPerRowIterator("s0", fields, expectedOne);
            env.assertSafeIterator("s0", iterator -> EPAssertionUtil.assertPropsPerRow(iterator, fields, expectedOne));

            env.milestone(0);

            env.sendEventBean(new SupportBean("E1", 2));
            Object[][] expectedTwo = new Object[][]{{DateTime.parseDefaultMSec("2002-05-1T08:00:00.000"), "E1", 1}, {DateTime.parseDefaultMSec("2002-05-1T08:00:00.000"), "E1", 2}};
            env.assertPropsPerRowIterator("s0", fields, expectedTwo);
            env.assertSafeIterator("s0", iterator -> EPAssertionUtil.assertPropsPerRow(iterator, fields, expectedTwo));
    ...
    private static class ContextNestedNestingFilterCorrectness implements RegressionExecution {
        ...
        private static void assertFilters(RegressionEnvironment env, String expected, String name) {
            env.assertThat(() -> assertEquals(expected, SupportFilterServiceHelper.getFilterSvcToString(env, name)));
        }
    }
    ...
    private static class ContextNestedCategoryOverPatternInitiated implements RegressionExecution {
        public void run(RegressionEnvironment env) {
            ...
            env.assertPropsPerRowLastNew("s0", fields, new Object[][]{{"g2", "S0_1", "S1_2", 3}});

            env.milestone(5);

            env.sendEventBean(new SupportBean("E4", -2));
            env.assertPropsPerRowLastNew("s0", fields, new Object[][]{{"g1", "S0_1", "S1_2", -2}});

            env.sendEventBean(new SupportBean("E5", 0));
            env.assertPropsPerRowLastNew("s0", fields, new Object[][]{{"g3", "S0_1", "S1_2", 0}});

            env.sendEventBean(new SupportBean("E3", 5));
            env.assertPropsPerRowLastNew("s0", fields, new Object[][]{{"g2", "S0_1", "S1_2", 8}});

            env.sendEventBean(new SupportBean("E6", 6));
            env.assertPropsPerRowLastNew("s0", fields, new Object[][]{{"g2", "S0_1", "S1_2", 6}});
            ...
            env.assertPropsPerRowLastNew("s0", fields, new Object[][]{{"g2", "S0_1", "S1_2", 15}, {"g2", "S0_3", "S1_3", 7}});
            ...
            env.assertPropsPerRowLastNew("s0", fields, new Object[][]{{"g2", "S0_4", "S1_4", 9}});
    ...
    private static class ContextNestedPartitionedWithFilterNonOverlap implements RegressionExecution {
        public void run(RegressionEnvironment env) {
            ...
            env.sendEventBean(new SupportBean("E1", 2));
            env.assertPropsPerRowLastNew("s0", fields, new Object[][]{{"S0_1", "E1", 2}});
            ...
            env.assertPropsPerRowLastNew("s0", fields, new Object[][]{{"S0_2", "E2", 4}});

            env.milestone(5);

            env.sendEventBean(new SupportBean("E1", 6));
            env.assertPropsPerRowLastNew("s0", fields, new Object[][]{{"S0_1", "E1", 8}, {"S0_2", "E1", 6}});
    ...
    private static class ContextNestedSingleEventTriggerNested implements RegressionExecution {
        public void run(RegressionEnvironment env) {
            ...
            env.assertPropsPerRowLastNew("s0", fieldsOne, new Object[][]{{"E1", 10, 100L, 1L}});

            env.milestoneInc(milestone);

            env.sendEventBean(makeEvent("E2", 10, 100));
            env.assertPropsPerRowLastNew("s0", fieldsOne, new Object[][]{{"E2", 10, 100L, 1L}});

            env.milestoneInc(milestone);

            env.sendEventBean(makeEvent("E1", 11, 100));
            env.assertPropsPerRowLastNew("s0", fieldsOne, new Object[][]{{"E1", 11, 100L, 1L}});

            env.milestoneInc(milestone);

            env.sendEventBean(makeEvent("E1", 10, 101));
            env.assertPropsPerRowLastNew("s0", fieldsOne, new Object[][]{{"E1", 10, 101L, 1L}});

            env.sendEventBean(makeEvent("E1", 10, 100));
            env.assertPropsPerRowLastNew("s0", fieldsOne, new Object[][]{{"E1", 10, 100L, 2L}});
            ...
            env.assertPropsPerRowLastNew("s0", fieldsTwo, new Object[][]{{"E1", 1L}});

            env.milestoneInc(milestone);

            env.sendEventBean(new SupportBean("E2", 0));
            env.assertPropsPerRowLastNew("s0", fieldsTwo, new Object[][]{{"E2", 1L}});

            env.sendEventBean(new SupportBean("E1", 0));
            env.assertPropsPerRowLastNew("s0", fieldsTwo, new Object[][]{{"E1", 2L}});
            ...
            env.assertPropsPerRowLastNew("s0", fieldsThree, new Object[][]{{"I1", 1L}});
    ...
    private static class ContextNestedFourContextsNested implements RegressionExecution {
        public void run(RegressionEnvironment env) {
            ...
            env.sendEventBean(new SupportBean("E2", 2));
            env.assertPropsPerRowLastNew("s0", fields, new Object[][]{{"S0_2", "S1_2", "S2_2", 2}});

            env.sendEventBean(new SupportBean("E3", 3));
            env.assertPropsPerRowLastNew("s0", fields, new Object[][]{{"S0_2", "S1_2", "S2_2", 5}});
            ...
            env.assertPropsPerRowLastNew("s0", fields, new Object[][]{{"S0_2", "S1_2", "S2_2", 9}});

            env.milestoneInc(milestone);

            env.sendEventBean(new SupportBean_S2(201, "S2_3"));
            env.sendEventBean(new SupportBean("E5", 5));
            env.assertPropsPerRowLastNew("s0", fields, new Object[][]{{"S0_2", "S1_2", "S2_2", 14}, {"S0_2", "S1_2", "S2_3", 5}, {"S0_2", "S1_3", "S2_3", 5}});
            ...
            env.sendEventBean(new SupportBean("E6", 6));
            env.assertPropsPerRowLastNew("s0", fields, new Object[][]{{"S0_2", "S1_2", "S2_3", 11}, {"S0_2", "S1_3", "S2_3", 11}});
            ...
            env.assertPropsPerRowLastNew("s0", fields, new Object[][]{{"S0_2", "S1_2", "S2_4", 8}, {"S0_2", "S1_3", "S2_4", 8}});
            ...
            env.assertPropsPerRowLastNew("s0", fields, new Object[][]{{"S0_2", "S1_3", "S2_5", 10}, {"S0_2", "S1_5", "S2_5", 10}});
            ...
            env.assertPropsPerRowLastNew("s0", fields, new Object[][]{{"S0_6", "S1_6", "S2_6", 12}});
            ...
            env.assertPropsPerRowLastNew("s0", fields, new Object[][]{{"S0_8", "S1_8", "S2_8", 15}});
    ...
    private static class ContextNestedTemporalOverlapOverPartition implements RegressionExecution {
        public void run(RegressionEnvironment env) {
            ...
            env.assertPropsPerRowLastNew("s0", fields, new Object[][]{{"S0_2", "E3", 14}, {"S0_4", "E3", 6}});

            env.milestone(4);

            env.sendEventBean(new SupportBean("E4", 7));
            env.assertPropsPerRowLastNew("s0", fields, new Object[][]{{"S0_2", "E4", 11}, {"S0_4", "E4", 7}});
    ...
    private static class ContextNestedFixedTemporalOverPartitioned implements RegressionExecution {
        public void run(RegressionEnvironment env) {
            ...
            sendTimeEvent(env, "2002-05-1T08:00:00.000");
            env.assertThat(() -> assertEquals(1, SupportFilterServiceHelper.getFilterSvcCountApprox(env)));

            env.sendEventBean(new SupportBean("E1", 0));
            env.assertPropsNew("s0", fields, new Object[]{1L});
            env.assertThat(() -> assertEquals(2, SupportFilterServiceHelper.getFilterSvcCountApprox(env)));
        ...
        public EnumSet<RegressionFlag> flags() {
            return EnumSet.of(RegressionFlag.OBSERVEROPS, RegressionFlag.STATICHOOK);
        }
    }
    ...
    private static class ContextNestedPartitionedOverFixedTemporal implements RegressionExecution {
        public void run(RegressionEnvironment env) {
            ...
            env.sendEventBean(new SupportBean("E2", 0));
            env.assertListenerNotInvoked("s0");
            env.assertThat(() -> assertEquals(2, SupportScheduleHelper.scheduleCountOverall(env.runtime())));
    ...
    private static class ContextNestedContextProps implements RegressionExecution {
        public void run(RegressionEnvironment env) {
            ...
            env.assertPropsNew("s0", fields, new Object[]{"EightToNine", DateTime.parseDefaultMSec("2002-05-1T08:30:00.000"),
    ...
    public static class ContextNestedInitTermOverHashIterate implements RegressionExecution {
        ...
        public void run(RegressionEnvironment env) {
            ...
            // all-selector
            SupportSelectorNested selectorNestedOne = new SupportSelectorNested(new ContextPartitionSelectorAll(), new ContextPartitionSelectorAll());
            env.assertStatement("s0", statement -> EPAssertionUtil.assertPropsPerRowAnyOrder(statement.iterator(selectorNestedOne), fields, expectedAll));
            // hash-specific-selector
            SupportSelectorNested selectorNestedTwo = new SupportSelectorNested(new ContextPartitionSelectorAll(), SupportSelectorByHashCode.fromSetOfAll(4));
            env.assertStatement("s0", statement -> EPAssertionUtil.assertPropsPerRowAnyOrder(statement.iterator(selectorNestedTwo), fields, expectedAll));
            // filter-specific-selector
            SupportSelectorNested selectorNestedThree = new SupportSelectorNested(new ContextPartitionSelectorAll(), new SupportSelectorFilteredPassAll());
            env.assertStatement("s0", statement -> EPAssertionUtil.assertPropsPerRowAnyOrder(statement.iterator(selectorNestedThree), fields, expectedAll));
            // id-specific-selector
            SupportSelectorNested selectorNestedFour = new SupportSelectorNested(new ContextPartitionSelectorAll(), SupportSelectorById.fromSetOfAll(100));
            env.assertStatement("s0", statement -> EPAssertionUtil.assertPropsPerRowAnyOrder(statement.iterator(selectorNestedFour), fields, expectedAll));
    ...
    public static class ContextNestedInitTermOverPartitionedIterate implements RegressionExecution {
        ...
        public void run(RegressionEnvironment env) {
            ...
            SupportSelectorNested selectorNestedTwo = new SupportSelectorNested(new ContextPartitionSelectorAll(), new SupportSelectorPartitioned(Arrays.asList(new Object[]{"E1"}, new Object[]{"E2"})));
            env.assertStatement("s0", statement -> EPAssertionUtil.assertPropsPerRowAnyOrder(statement.iterator(selectorNestedTwo), fields, expectedAll));
            // filter-specific-selector
            SupportSelectorNested selectorNestedThree = new SupportSelectorNested(new ContextPartitionSelectorAll(), new SupportSelectorFilteredPassAll());
            env.assertStatement("s0", statement -> EPAssertionUtil.assertPropsPerRowAnyOrder(statement.iterator(selectorNestedThree), fields, expectedAll));
    ...
    public static class ContextNestedInitTermOverCategoryIterate implements RegressionExecution {
        ...
        public void run(RegressionEnvironment env) {
            ...
            SupportSelectorNested selectorNestedTwo = new SupportSelectorNested(new ContextPartitionSelectorAll(), new SupportSelectorCategory(new HashSet(Arrays.asList("cat1,cat2".split(",")))));
            env.assertStatement("s0", statement -> EPAssertionUtil.assertPropsPerRowAnyOrder(statement.iterator(selectorNestedTwo), fields, expectedAll));
            // filter-specific-selector
            SupportSelectorNested selectorNestedThree = new SupportSelectorNested(new ContextPartitionSelectorAll(), new SupportSelectorFilteredPassAll());
            env.assertStatement("s0", statement -> EPAssertionUtil.assertPropsPerRowAnyOrder(statement.iterator(selectorNestedThree), fields, expectedAll));
    ...
    public static class ContextNestedInitTermOverInitTermIterate implements RegressionExecution {
        ...
        public void run(RegressionEnvironment env) {
            ...
            env.assertStatement("s0", statement -> EPAssertionUtil.assertPropsPerRowAnyOrder(statement.iterator(selectorNestedOne), fields, expectedAll));
            // filter-specific-selector
            SupportSelectorNested  selectorNestedTwo = new SupportSelectorNested(new ContextPartitionSelectorAll(), new SupportSelectorFilteredPassAll());
            env.assertStatement("s0", statement -> EPAssertionUtil.assertPropsPerRowAnyOrder(statement.iterator(selectorNestedTwo), fields, expectedAll));
    ...
    private static void tryAssertion(RegressionEnvironment env, RegressionPath path) {
        ...
        env.assertPropsPerRowIRPairFlattened("s0", fields, new Object[][]{{"E1", 1}, {"E2", 2}}, null);
        ...
        env.assertPropsPerRowIRPairFlattened("s0", fields, new Object[][]{{"E1", 3}, {"E3", 4}}, null);
    ...
    private static void assertNested(ContextPartitionIdentifierNested nested, String startTime) {
        assertEquals(DateTime.parseDefaultMSec(startTime), ((ContextPartitionIdentifierInitiatedTerminated) nested.getIdentifiers()[0]).getStartTime());
        assertEquals("g2", ((ContextPartitionIdentifierCategory) nested.getIdentifiers()[1]).getLabel());
        EPAssertionUtil.assertEqualsExactOrder(new Object[]{"E1"}, ((ContextPartitionIdentifierPartitioned) nested.getIdentifiers()[2]).getKeys());
    }
