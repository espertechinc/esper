...
public class SupportReferenceCountedMapAccessor implements AggregationMultiFunctionAccessor {
    public Object getValue(AggregationMultiFunctionState state, EventBean[] eventsPerStream, boolean isNewData, ExprEvaluatorContext exprEvaluatorContext) {
        SupportReferenceCountedMapState map = (SupportReferenceCountedMapState) state;
        return map.getCountPerReference();
    }
