...
public class SupportSimpleWordCSVFactory implements AggregationFunctionFactory {
    public final static EPTypeClass EPTYPE = new EPTypeClass(SupportSimpleWordCSVFactory.class);
