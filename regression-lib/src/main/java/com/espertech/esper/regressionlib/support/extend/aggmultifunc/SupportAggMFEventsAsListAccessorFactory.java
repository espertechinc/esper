...
public class SupportAggMFEventsAsListAccessorFactory implements AggregationMultiFunctionAccessorFactory {
    public final static EPTypeClass EPTYPE = new EPTypeClass(SupportAggMFEventsAsListAccessorFactory.class);
