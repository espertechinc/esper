...
public class MyObjectArrayGraphSourceFactory implements DataFlowOperatorFactory {
    public final static EPTypeClass EPTYPE = new EPTypeClass(MyObjectArrayGraphSourceFactory.class);
