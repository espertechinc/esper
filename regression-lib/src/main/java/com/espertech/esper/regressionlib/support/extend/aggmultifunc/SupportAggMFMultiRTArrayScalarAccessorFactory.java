...
public class SupportAggMFMultiRTArrayScalarAccessorFactory implements AggregationMultiFunctionAccessorFactory {
    public final static EPTypeClass EPTYPE = new EPTypeClass(SupportAggMFMultiRTArrayScalarAccessorFactory.class
    );
