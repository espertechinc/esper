...
public class SupportSingleRowFunction {
    private final static List<EPLMethodInvocationContext> METHOD_INVOCATION_CONTEXTS = new ArrayList<EPLMethodInvocationContext>();

    public static List<EPLMethodInvocationContext> getMethodInvocationContexts() {
        return METHOD_INVOCATION_CONTEXTS;
    }
    ...
    public static int computePower3WithContext(int i, EPLMethodInvocationContext context) {
        METHOD_INVOCATION_CONTEXTS.add(context);
        return i * i * i;
    }
    ...
    public static String varargOverload(int a, int b) {
        return "p2";
    }

    public static String varargOverload(int a, int b, int c) {
        return "p3";
    }

    public static String varargOverload(int... many) {
        return "many";
    }
