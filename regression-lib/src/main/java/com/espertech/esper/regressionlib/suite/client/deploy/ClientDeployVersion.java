...
public class ClientDeployVersion {
    ...
    private static class ClientDeployVersionMinorCheck implements RegressionExecution {
        public void run(RegressionEnvironment env) {
            ...
            String versionMismatchMsg = "Major or minor version of compiler and runtime mismatch; The runtime version is 8.8.0 and the compiler version of the compiled unit is 8.0.0";
            try {
            ...
            try {
                ...
                assertMessage(ex, "Major or minor version of compiler and runtime mismatch; The runtime version is 8.8.0 and the compiler version of the compiled unit is 8.0.0");
            }
        }
