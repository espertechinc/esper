...
public class ViewInvalid implements RegressionExecution {
    ...
    private void runAssertionStatementException(RegressionEnvironment env) {
        ...
        SupportMessageAssertUtil.assertMessage(exception, "Failed to resolve event type, named window or table by name 'dummypkg.dummy' [select * from dummypkg.dummy()#length(10)]");
