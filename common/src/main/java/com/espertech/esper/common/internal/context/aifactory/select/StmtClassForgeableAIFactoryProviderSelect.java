...
public class StmtClassForgeableAIFactoryProviderSelect extends StmtClassForgeableAIFactoryProviderBase {
    private final StatementAgentInstanceFactoryForge forge;

    public StmtClassForgeableAIFactoryProviderSelect(String className, CodegenPackageScope packageScope, StatementAgentInstanceFactoryForge forge) {
        super(className, packageScope);
        this.forge = forge;
    }

    protected EPTypeClass typeOfFactory() {
        return StatementAgentInstanceFactorySelect.EPTYPE;
    }
