...
public class ExprInstanceofNode extends ExprNodeBase {
    ...
    public ExprNode validate(ExprValidationContext validationContext) throws ExprValidationException {
        ...
        Set<Class> classList = getClassSet(classIdentifiers, validationContext.getClasspathImportService());
        Class[] classes;
        synchronized (this) {
    ...
    private Set<Class> getClassSet(String[] classIdentifiers, ClasspathImportServiceCompileTime classpathImportService)
