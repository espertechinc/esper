...
public interface ResultSetProcessorSimpleOutputLastHelper extends ResultSetProcessorOutputHelper {
    EPTypeClass EPTYPE = new EPTypeClass(ResultSetProcessorSimpleOutputLastHelper.class);

    void processView(EventBean[] newData, EventBean[] oldData);

    void processJoin(Set<MultiKeyArrayOfKeys<EventBean>> newEvents, Set<MultiKeyArrayOfKeys<EventBean>> oldEvents);
