...
public final class JsonGetterIndexedRuntimeIndex implements EventPropertyGetterIndexedSPI {
    ...
    public CodegenExpression eventBeanGetIndexedCodegen(CodegenMethodScope codegenMethodScope, CodegenClassScope codegenClassScope, CodegenExpression beanExpression, CodegenExpression key) {
        return staticMethod(JsonFieldGetterHelper.class, "getJsonIndexedProp", exprDotMethod(beanExpression, "getUnderlying"), constant(field.getPropertyNumber()), key);
    }

    public Object get(EventBean eventBean, int index) throws PropertyAccessException {
        return JsonFieldGetterHelper.getJsonIndexedProp(eventBean.getUnderlying(), field.getPropertyNumber(), index);
    }
}
