...
public class EnumLastOfNoPredicateForge extends EnumForgeBase implements EnumForge, EnumEval {
    ...
    public CodegenExpression codegen(EnumForgeCodegenParams args, CodegenMethodScope codegenMethodScope, CodegenClassScope codegenClassScope) {
        ...
        CodegenMethod method = codegenMethodScope.makeChild(type, EnumLastOfNoPredicateForge.class, codegenClassScope).addParam(EnumForgeCodegenNames.PARAMS).getBlock()
