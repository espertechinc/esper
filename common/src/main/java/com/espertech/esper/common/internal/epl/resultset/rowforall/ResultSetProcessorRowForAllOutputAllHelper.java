...
public interface ResultSetProcessorRowForAllOutputAllHelper extends ResultSetProcessorOutputHelper {
    EPTypeClass EPTYPE = new EPTypeClass(ResultSetProcessorRowForAllOutputAllHelper.class);
