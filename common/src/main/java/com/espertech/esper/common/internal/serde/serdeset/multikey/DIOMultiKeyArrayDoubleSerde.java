...
public class DIOMultiKeyArrayDoubleSerde implements DIOMultiKeyArraySerde<MultiKeyArrayDouble> {
    public final static EPTypeClass EPTYPE = new EPTypeClass(DIOMultiKeyArrayDoubleSerde.class);
