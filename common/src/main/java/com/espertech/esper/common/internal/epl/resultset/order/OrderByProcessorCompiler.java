...
public class OrderByProcessorCompiler {
    ...
    private static void makeFactory(OrderByProcessorFactoryForge forge, CodegenClassScope classScope, List<CodegenInnerClass> innerClasses, String providerClassName) {
        CodegenMethod instantiateMethod = CodegenMethod.makeParentNode(OrderByProcessor.class, OrderByProcessorCompiler.class, CodegenSymbolProviderEmpty.INSTANCE, classScope).addParam(AgentInstanceContext.class, REF_AGENTINSTANCECONTEXT.getRef());
