...
public class ModuleClassProvidedInitializeSymbol implements CodegenSymbolProvider {
    public final static CodegenExpressionRef REF_INITSVC = ref("moduleClassProvidedInitSvc");
    ...
    public void provide(Map<String, EPTypeClass> symbols) {
        if (optionalInitServicesRef != null) {
            symbols.put(optionalInitServicesRef.getRef(), EPModuleClassProvidedInitServices.EPTYPE);
        }
    }
}
