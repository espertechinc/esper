...
public class ModuleTableInitializeSymbol implements CodegenSymbolProvider {
    public final static CodegenExpressionRef REF_INITSVC = ref("moduleTableInitSvc");
    ...
    public void provide(Map<String, EPTypeClass> symbols) {
        if (optionalInitServicesRef != null) {
            symbols.put(optionalInitServicesRef.getRef(), EPModuleTableInitServices.EPTYPE);
        }
    }
}
