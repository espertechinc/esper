...
public class DIOObjectArrayNullableSerdeCombined implements DataInputOutputSerde<Object[]> {
    private final Class componentType;
    private final DataInputOutputSerde componentBinding;

    public DIOObjectArrayNullableSerdeCombined(Class componentType, DataInputOutputSerde componentBinding) {
