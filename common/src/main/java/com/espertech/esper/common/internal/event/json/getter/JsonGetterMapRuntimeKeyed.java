 ...
 */
public final class JsonGetterMapRuntimeKeyed implements EventPropertyGetterMappedSPI {
    private final JsonUnderlyingField field;

    public JsonGetterMapRuntimeKeyed(JsonUnderlyingField field) {
        this.field = field;
    }
    ...
    public CodegenExpression eventBeanGetMappedCodegen(CodegenMethodScope codegenMethodScope, CodegenClassScope codegenClassScope, CodegenExpression beanExpression, CodegenExpression key) {
        return staticMethod(JsonFieldGetterHelper.class, "getJsonMappedProp", exprDotMethod(beanExpression, "getUnderlying"), constant(field.getPropertyNumber()), key);
    }

    public Object get(EventBean eventBean, String mapKey) throws PropertyAccessException {
        return JsonFieldGetterHelper.getJsonMappedProp(eventBean.getUnderlying(), field.getPropertyNumber(), mapKey);
    }
}
