...
public class CorrelationViewFactory implements ViewFactory {
    public final static EPTypeClass EPTYPE = new EPTypeClass(CorrelationViewFactory.class);
    ...
    public View makeView(AgentInstanceViewFactoryChainContext agentInstanceViewFactoryContext) {
        return new CorrelationView(this, agentInstanceViewFactoryContext.getAgentInstanceContext(), expressionXEval, expressionYEval, eventType, additionalProps);
    }
    ...
    public String getViewName() {
        return ViewEnum.CORRELATION.getName();
    }
}
