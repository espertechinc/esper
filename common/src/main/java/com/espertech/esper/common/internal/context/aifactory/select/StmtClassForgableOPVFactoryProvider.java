...
public class StmtClassForgableOPVFactoryProvider implements StmtClassForgable {
    ...
    public CodegenClass forge(boolean includeDebugSymbols) {
        ...
        try {
            ...
            CodegenCtor providerCtor = new CodegenCtor(StmtClassForgableOPVFactoryProvider.class, includeDebugSymbols, ctorParms);
            ...
            // render and compile
            return new CodegenClass(OutputProcessViewFactoryProvider.class, packageScope.getPackageName(), className, classScope, providerExplicitMembers, providerCtor, methods, innerClasses);
        } catch (Throwable t) {
    ...
    public StmtClassForgableType getForgableType() {
        return StmtClassForgableType.OPVPROVIDER;
    }
    ...
    private static void makeOPVFactory(CodegenClassScope classScope, List<CodegenInnerClass> innerClasses, List<CodegenTypedParam> providerExplicitMembers, CodegenCtor providerCtor, String providerClassName) {
        CodegenMethod makeViewMethod = CodegenMethod.makeParentNode(OutputProcessView.class, StmtClassForgableOPVFactoryProvider.class, CodegenSymbolProviderEmpty.INSTANCE, classScope)
        ...
        CodegenCtor ctor = new CodegenCtor(StmtClassForgableOPVFactoryProvider.class, classScope, ctorParams);
    ...
    private static void makeOPV(CodegenClassScope classScope, List<CodegenInnerClass> innerClasses, List<CodegenTypedParam> factoryExplicitMembers, CodegenCtor factoryCtor, String classNameParent, OutputProcessViewFactoryForge forge, int numStreams) {
        ...
        // make ctor code
        CodegenCtor serviceCtor = new CodegenCtor(StmtClassForgableOPVFactoryProvider.class, classScope, ctorParams);
