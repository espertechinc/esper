...
public class DIOBoxedIntegerArrayNullableSerde implements DataInputOutputSerde<Integer[]> {
    public final static EPTypeClass EPTYPE = new EPTypeClass(DIOBoxedIntegerArrayNullableSerde.class);

    public final static DIOBoxedIntegerArrayNullableSerde INSTANCE = new DIOBoxedIntegerArrayNullableSerde();
