...
public class TwoLambdaThreeFormScalarFactory implements EnumForgeDescFactory {
    ...
    public EnumForgeDesc makeEnumForgeDesc(List<ExprDotEvalParam> bodiesAndParameters, int streamCountIncoming, StatementCompileTimeServices services) {
        ...
        return function.apply(first, second, typeFirst, typeSecond, streamCountIncoming, numParams);
    }
    ...
    public interface ForgeFunction {
        EnumForgeDesc apply(ExprDotEvalParamLambda first, ExprDotEvalParamLambda second, ObjectArrayEventType eventTypeFirst, ObjectArrayEventType eventTypeSecond, int streamCountIncoming, int numParams);
    }
}
