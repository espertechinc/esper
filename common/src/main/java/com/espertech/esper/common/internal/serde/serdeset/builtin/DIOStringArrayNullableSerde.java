...
public class DIOStringArrayNullableSerde implements DataInputOutputSerde<String[]> {
    public final static EPTypeClass EPTYPE = new EPTypeClass(DIOStringArrayNullableSerde.class);

    public final static DIOStringArrayNullableSerde INSTANCE = new DIOStringArrayNullableSerde();
