...
public class ExprDotForgeSizeCollection implements ExprDotForge, ExprDotEval {
    ...
    public CodegenExpression codegen(CodegenExpression inner, Class innerType, CodegenMethodScope parent, ExprForgeCodegenSymbol symbols, CodegenClassScope classScope) {
        CodegenMethod method = parent.makeChild(Integer.class, ExprDotForgeSizeCollection.class, classScope).addParam(innerType, "target").getBlock()
