...
public class StmtClassForgableRSPFactoryProvider implements StmtClassForgable {
    ...
    public CodegenClass forge(boolean includeDebugSymbols) {
        ...
        try {
            ...
            CodegenCtor providerCtor = new CodegenCtor(StmtClassForgableRSPFactoryProvider.class, includeDebugSymbols, ctorParms);
            ...
            // render and compile
            return new CodegenClass(ResultSetProcessorFactoryProvider.class, packageScope.getPackageName(), className, classScope, providerExplicitMembers, providerCtor, methods, innerClasses);
        } catch (Throwable t) {
    ...
    private static void makeResultSetProcessorFactory(CodegenClassScope classScope, List<CodegenInnerClass> innerClasses, List<CodegenTypedParam> providerExplicitMembers, CodegenCtor providerCtor, String providerClassName) {
        CodegenMethod instantiateMethod = CodegenMethod.makeParentNode(ResultSetProcessor.class, StmtClassForgableRSPFactoryProvider.class, CodegenSymbolProviderEmpty.INSTANCE, classScope)
        ...
        CodegenCtor ctor = new CodegenCtor(StmtClassForgableRSPFactoryProvider.class, classScope, ctorParams);
    ...
    private static void makeResultSetProcessor(CodegenClassScope classScope, List<CodegenInnerClass> innerClasses, List<CodegenTypedParam> factoryExplicitMembers, CodegenCtor factoryCtor, String classNameParent, ResultSetProcessorDesc spec) {
        ...
        // make ctor code
        CodegenCtor serviceCtor = new CodegenCtor(StmtClassForgableRSPFactoryProvider.class, classScope, ctorParams);
    ...
    private static CodegenInnerClass makeSelectExprProcessor(String className, String classNameParent, CodegenClassScope classScope, SelectExprProcessorForge forge) {
        ...
        CodegenMethod processMethod = CodegenMethod.makeParentNode(EventBean.class, StmtClassForgableRSPFactoryProvider.class, symbolProvider, classScope)
    ...
    public StmtClassForgableType getForgableType() {
        return StmtClassForgableType.RSPPROVIDER;
    }
}
