...
public class StmtClassForgableAIFactoryProviderOnTrigger extends StmtClassForgableAIFactoryProviderBase {
    private final StatementAgentInstanceFactoryOnTriggerBaseForge forge;

    public StmtClassForgableAIFactoryProviderOnTrigger(String className, CodegenPackageScope packageScope, StatementAgentInstanceFactoryOnTriggerBaseForge forge) {
