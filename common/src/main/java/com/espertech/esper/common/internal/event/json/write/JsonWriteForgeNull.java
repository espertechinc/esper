...
public class JsonWriteForgeNull implements JsonWriteForge {

    public final static JsonWriteForgeNull INSTANCE = new JsonWriteForgeNull();
    ...
    public CodegenExpression codegenWrite(JsonWriteForgeRefs refs, CodegenMethod method, CodegenClassScope classScope) {
        return exprDotMethod(refs.getWriter(), "writeLiteral", constant("null"));
    }
}
