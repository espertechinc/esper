...
public class JsonGetterDynamicSimple implements JsonEventPropertyGetter {
    private final String propertyName;

    public JsonGetterDynamicSimple(String propertyName) {
    ...
    public CodegenExpression underlyingGetCodegen(CodegenExpression underlyingExpression, CodegenMethodScope codegenMethodScope, CodegenClassScope codegenClassScope) {
        return staticMethod(JsonGetterDynamicHelper.class, "getJsonPropertySimpleValue", constant(propertyName), underlyingExpression);
    }
    ...
    public CodegenExpression underlyingExistsCodegen(CodegenExpression underlyingExpression, CodegenMethodScope codegenMethodScope, CodegenClassScope codegenClassScope) {
        return staticMethod(JsonGetterDynamicHelper.class, "getJsonPropertySimpleExists", constant(propertyName), underlyingExpression);
    }
