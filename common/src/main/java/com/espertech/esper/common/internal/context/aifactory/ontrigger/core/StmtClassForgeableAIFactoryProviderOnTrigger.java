...
public class StmtClassForgeableAIFactoryProviderOnTrigger extends StmtClassForgeableAIFactoryProviderBase {
    private final StatementAgentInstanceFactoryOnTriggerBaseForge forge;

    public StmtClassForgeableAIFactoryProviderOnTrigger(String className, CodegenPackageScope packageScope, StatementAgentInstanceFactoryOnTriggerBaseForge forge) {
        super(className, packageScope);
        this.forge = forge;
    }

    protected EPTypeClass typeOfFactory() {
        return StatementAgentInstanceFactoryOnTriggerBase.EPTYPE;
    }
