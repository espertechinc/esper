...
public interface ViewResolutionService {
    /**
     * Instantiates a {@link ViewFactoryForge} based on the view namespace and name stored in the view spec.
     * <p>
     * Does not actually use the view factory object created.
     *
     * @param namespace                     is the view namespace
     * @param name                          is the view name
     * @param optionalCreateNamedWindowName named window name
     * @return {@link ViewFactoryForge} instance
