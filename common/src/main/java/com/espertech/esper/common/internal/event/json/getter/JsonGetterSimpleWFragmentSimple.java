...
public class JsonGetterSimpleWFragmentSimple extends JsonGetterSimpleBase {
    ...
    public JsonGetterSimpleWFragmentSimple(JsonUnderlyingField field, String underlyingClassName, EventType fragmentType, EventBeanTypedEventFactory eventBeanTypedEventFactory) {
    ...
    public CodegenExpression underlyingFragmentCodegen(CodegenExpression underlyingExpression, CodegenMethodScope codegenMethodScope, CodegenClassScope codegenClassScope) {
        ...
        return staticMethod(JsonFieldGetterHelper.class, "handleJsonCreateFragmentSimple", underlyingExpression, constant(field.getPropertyNumber()), eventType, factory);
    }
    ...
    public Object getJsonFragment(Object object) throws PropertyAccessException {
        ...
        return JsonFieldGetterHelper.handleJsonCreateFragmentSimple((JsonEventObjectBase) object, field.getPropertyNumber(), fragmentType, eventBeanTypedEventFactory);
    }
}
