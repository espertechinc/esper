...
public class AgregationMethodCountMinSketchFreqForge implements AggregationMethodForge {
    ...
    public CodegenExpression codegenCreateReader(CodegenMethodScope parent, SAIFFInitializeSymbol symbols, CodegenClassScope classScope) {
        CodegenMethod method = parent.makeChild(AgregationMethodCountMinSketchFreq.class, this.getClass(), classScope);
        method.getBlock()
                .declareVar(AgregationMethodCountMinSketchFreq.class, "strat", newInstance(AgregationMethodCountMinSketchFreq.class))
