 ...
 */
public class DIOStringSerde implements DataInputOutputSerde<String> {
    public final static EPTypeClass EPTYPE = new EPTypeClass(DIOStringSerde.class);

    public final static DIOStringSerde INSTANCE = new DIOStringSerde();
