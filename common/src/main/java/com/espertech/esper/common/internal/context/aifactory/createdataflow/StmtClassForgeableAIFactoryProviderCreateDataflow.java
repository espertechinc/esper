...
public class StmtClassForgeableAIFactoryProviderCreateDataflow extends StmtClassForgeableAIFactoryProviderBase {
    private final StatementAgentInstanceFactoryCreateDataflowForge forge;

    public StmtClassForgeableAIFactoryProviderCreateDataflow(String className, CodegenPackageScope packageScope, StatementAgentInstanceFactoryCreateDataflowForge forge) {
