...
public class DIOMultiKeyArrayLongSerde implements DIOMultiKeyArraySerde<MultiKeyArrayLong> {
    public final static EPTypeClass EPTYPE = new EPTypeClass(DIOMultiKeyArrayLongSerde.class);
