...
public class ExprEqualsNodeForgeNCEvalEqualsNonArray extends ExprEqualsNodeForgeNCEvalBase {
    public ExprEqualsNodeForgeNCEvalEqualsNonArray(ExprEqualsNodeImpl parent, ExprEvaluator lhs, ExprEvaluator rhs) {
