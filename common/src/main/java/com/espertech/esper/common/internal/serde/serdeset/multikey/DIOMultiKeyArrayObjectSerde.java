...
public class DIOMultiKeyArrayObjectSerde implements DIOMultiKeyArraySerde<MultiKeyArrayObject> {
    public final static EPTypeClass EPTYPE = new EPTypeClass(DIOMultiKeyArrayObjectSerde.class);
