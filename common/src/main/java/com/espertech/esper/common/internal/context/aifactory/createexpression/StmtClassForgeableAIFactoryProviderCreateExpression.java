...
public class StmtClassForgeableAIFactoryProviderCreateExpression extends StmtClassForgeableAIFactoryProviderBase {
    private final StatementAgentInstanceFactoryCreateExpressionForge forge;

    public StmtClassForgeableAIFactoryProviderCreateExpression(String className, CodegenPackageScope packageScope, StatementAgentInstanceFactoryCreateExpressionForge forge) {
        super(className, packageScope);
        this.forge = forge;
    }

    protected EPTypeClass typeOfFactory() {
        return StatementAgentInstanceFactoryCreateExpression.EPTYPE;
    }
