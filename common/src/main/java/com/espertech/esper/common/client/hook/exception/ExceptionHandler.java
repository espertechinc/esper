 ...
 * <p>
 * When the runtimeencounters an unchecked exception processing a continous-query statement it allows
 * any exception handler that is registered with the runtimeto handle the exception, in the order
