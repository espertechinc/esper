...
public abstract class AggregationAccessorMinMaxByBase implements AggregationAccessorForge {
    ...
    public void getEnumerableEventsCodegen(AggregationAccessorForgeGetCodegenContext context) {
        ...
        context.getMethod().getBlock()
            .declareVar(EventBean.EPTYPE, "bean", max ? forge.getLastValueCodegen(context.getClassScope(), context.getMethod()) : forge.getFirstValueCodegen(context.getClassScope(), context.getMethod()))
