...
public class JsonEndValueForgeFloat implements JsonEndValueForge {
    public final static JsonEndValueForgeFloat INSTANCE = new JsonEndValueForgeFloat();
    ...
    public CodegenExpression captureValue(JsonEndValueRefs refs, CodegenMethod method, CodegenClassScope classScope) {
        return staticMethod(JsonEndValueForgeFloat.class, "jsonToFloat", refs.getValueString(), refs.getName());
    }

    public static Float jsonToFloat(String value, String name) {
        return value == null ? null : jsonToFloatNonNull(value, name);
    }
    ...
    public static float jsonToFloatNonNull(String stringValue, String name) {
        try {
            ...
            throw handleNumberException(name, Float.class, stringValue, ex);
        }
    }
}
