 ...
 * <ol>
 * <li>
 * Use {@link EPTypeHelper#collectionOfEvents(com.espertech.esper.common.client.EventType)}
 * to indicate that the expression returns a collection of events.
 * </li>
 * <li>
 * Use {@link EPTypeHelper#singleEvent(com.espertech.esper.common.client.EventType)}
...
public class EPTypeHelper {
    ...
    public static Class getClassMultiValuedContainer(EPType type) {
        if (type instanceof ClassMultiValuedEPType) {
            return ((ClassMultiValuedEPType) type).getContainer();
        }
        return null;
    }
    ...
    public static EPType optionalFromEnumerationExpr(StatementRawInfo raw, StatementCompileTimeServices services, ExprNode exprNode)
