...
public class DOMConvertingGetter implements EventPropertyGetterSPI {
    ...
    public CodegenExpression underlyingGetCodegen(CodegenExpression underlyingExpression, CodegenMethodScope codegenMethodScope, CodegenClassScope codegenClassScope) {
        CodegenExpressionField parserMember = codegenClassScope.addFieldUnshared(true, SimpleTypeParser.class, SimpleTypeParserFactory.codegenSimpleParser(parser, codegenClassScope.getPackageScope().getInitMethod(), this.getClass(), codegenClassScope));
