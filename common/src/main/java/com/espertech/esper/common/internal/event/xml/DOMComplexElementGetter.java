...
public class DOMComplexElementGetter implements EventPropertyGetterSPI, DOMPropertyGetter {
     ...
     */
    public DOMComplexElementGetter(String propertyName, FragmentFactorySPI fragmentFactory, boolean isArray) {
    ...
    public CodegenExpression underlyingFragmentCodegen(CodegenExpression underlyingExpression, CodegenMethodScope codegenMethodScope, CodegenClassScope codegenClassScope) {
        ...
        if (!isArray) {
            ...
            return staticMethod(this.getClass(), "getValueAsNodeFragmentArray", underlyingExpression, constant(propertyName), ff);
        }
    }
