...
public abstract class SettingsApplicationDotMethodBase implements SettingsApplicationDotMethod {
    ...
    private void validateIndexNamedParameter(ExprValidationContext validationContext) throws ExprValidationException {
        ...
        optionalIndexConfig = provider.validateConfigureFilterIndex(optionalIndexName, indexTypeName, ExprNodeUtilityQuery.toArray(params), validationContext);
    }
