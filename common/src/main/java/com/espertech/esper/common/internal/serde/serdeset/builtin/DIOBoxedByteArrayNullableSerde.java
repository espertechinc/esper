...
public class DIOBoxedByteArrayNullableSerde implements DataInputOutputSerde<Byte[]> {
    public final static EPTypeClass EPTYPE = new EPTypeClass(DIOBoxedByteArrayNullableSerde.class);

    public final static DIOBoxedByteArrayNullableSerde INSTANCE = new DIOBoxedByteArrayNullableSerde();
