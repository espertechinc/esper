...
public final class ZeroDepthStreamIterableWAudit extends ZeroDepthStreamIterable {
    ...
    public ZeroDepthStreamIterableWAudit(EventType eventType, AgentInstanceContext agentInstanceContext, FilterSpecActivatable filterSpec, int streamNumber, boolean subselect, int subselectNumber) {
        super(eventType);
