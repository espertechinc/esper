...
public class DIOCollectionBigDecimalNullableSerde implements DataInputOutputSerde<Collection<BigDecimal>> {
    public final static EPTypeClass EPTYPE = new EPTypeClass(DIOCollectionBigDecimalNullableSerde.class);

    public final static DIOCollectionBigDecimalNullableSerde INSTANCE = new DIOCollectionBigDecimalNullableSerde();

    private DIOCollectionBigDecimalNullableSerde() {
    }
