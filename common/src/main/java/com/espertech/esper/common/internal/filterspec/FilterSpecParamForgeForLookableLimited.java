...
public class FilterSpecParamForgeForLookableLimited extends FilterSpecParamForge {

    private final ExprNode value;
    private final MatchedEventConvertorForge convertor;
    private final SimpleNumberCoercer numberCoercer;

    public FilterSpecParamForgeForLookableLimited(ExprFilterSpecLookupableFactoryForge lookupableFactoryForge, FilterOperator filterOperator, ExprNode value, MatchedEventConvertorForge convertor, SimpleNumberCoercer numberCoercer) {
        super(lookupableFactoryForge, filterOperator);
        this.value = value;
    ...
    public CodegenMethod makeCodegen(CodegenClassScope classScope, CodegenMethodScope parent, SAIFFInitializeSymbolWEventType symbols) {
        ...
        getFilterValue.getBlock()
            ...
            .declareVar(Object.class, "filterValue", valueExpr)
            .declareVar(ExprFilterSpecLookupable.class, "lookupable", exprDotMethod(ref("lookupableFactory"), "make", constantNull(), constantNull()))
            .methodReturn(newInstance(FilterValueSetParamImpl.class, ref("lookupable"), constant(filterOperator), ref("filterValue")));
