...
public class DIOPrimitiveDoubleArrayNullableSerde implements DataInputOutputSerde<double[]> {
    public final static EPTypeClass EPTYPE = new EPTypeClass(DIOPrimitiveDoubleArrayNullableSerde.class);

    public final static DIOPrimitiveDoubleArrayNullableSerde INSTANCE = new DIOPrimitiveDoubleArrayNullableSerde();
