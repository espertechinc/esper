...
public class DIOArrayListBooleanNullableSerde implements DataInputOutputSerde<Collection<Boolean>> {
    public final static EPTypeClass EPTYPE = new EPTypeClass(DIOArrayListBooleanNullableSerde.class);

    public final static DIOArrayListBooleanNullableSerde INSTANCE = new DIOArrayListBooleanNullableSerde();

    private DIOArrayListBooleanNullableSerde() {
    }
