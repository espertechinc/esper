...
public class TwoStreamQueryPlanBuilder {
     ...
     * @return query plan
     */
    public static QueryPlanForgeDesc build(EventType[] typesPerStream, QueryGraphForge queryGraph, OuterJoinType optionalOuterJoinType, StreamJoinAnalysisResultCompileTime streamJoinAnalysisResult) {
        ...
        List<StmtClassForgableFactory> additionalForgeable = new ArrayList<>(2);
        ...
        TableLookupPlanDesc plan1to0 = NStreamQueryPlanBuilder.createLookupPlan(queryGraph, 1, 0, streamJoinAnalysisResult.isVirtualDW(0), indexSpecs[0], typesPerStream, tablesPerStream[0]);
        lookupPlans[1] = plan1to0.getForge();
        additionalForgeable.addAll(plan1to0.getAdditionalForgeables());

        // plan lookup from zero to 1
        TableLookupPlanDesc plan0to1 = NStreamQueryPlanBuilder.createLookupPlan(queryGraph, 0, 1, streamJoinAnalysisResult.isVirtualDW(1), indexSpecs[1], typesPerStream, tablesPerStream[1]);
