...
public class StatementSpecRaw {
    ...
    private boolean hasPriorExpressions;
     ...
     *
     * @param havingClause the having-clause expression
     */
    public void setHavingClause(ExprNode havingClause) {
     ...
     *
     * @param whereClause where clause expression
     */
    ...
    public void setHasPriorExpressions(boolean hasPriorExpressions) {
        this.hasPriorExpressions = hasPriorExpressions;
    }
