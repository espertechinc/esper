...
public class EnumLastOfEventPlus extends ThreeFormEventPlus {

    public EnumLastOfEventPlus(ExprDotEvalParamLambda lambda, ObjectArrayEventType indexEventType, int numParameters) {
    ...
    public void initBlock(CodegenBlock block, CodegenMethod methodNode, ExprForgeCodegenSymbol scope, CodegenClassScope codegenClassScope) {
        block.declareVar(EventBean.EPTYPE, "result", constantNull());
    }
