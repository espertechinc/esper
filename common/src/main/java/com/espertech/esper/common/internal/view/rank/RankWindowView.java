...
public class RankWindowView extends ViewSupport implements DataWindowView {
    ...
    public final void update(EventBean[] newData, EventBean[] oldData) {
        agentInstanceContext.getAuditProvider().view(newData, oldData, agentInstanceContext, rankWindowViewFactory);
        agentInstanceContext.getInstrumentationProvider().qViewProcessIRStream(rankWindowViewFactory, newData, oldData);
        ...
        if (child != null) {
            ...
            agentInstanceContext.getInstrumentationProvider().qViewIndicate(rankWindowViewFactory, newData, expiredArr);
