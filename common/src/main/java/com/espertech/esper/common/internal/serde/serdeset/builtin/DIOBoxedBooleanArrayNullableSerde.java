...
public class DIOBoxedBooleanArrayNullableSerde implements DataInputOutputSerde<Boolean[]> {
    public final static EPTypeClass EPTYPE = new EPTypeClass(DIOBoxedBooleanArrayNullableSerde.class);

    public final static DIOBoxedBooleanArrayNullableSerde INSTANCE = new DIOBoxedBooleanArrayNullableSerde();
