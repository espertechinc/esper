...
public class StmtClassForgeableAIFactoryProviderCreateClass extends StmtClassForgeableAIFactoryProviderBase {
    private final StatementAgentInstanceFactoryCreateClassForge forge;

    public StmtClassForgeableAIFactoryProviderCreateClass(String className, CodegenPackageScope packageScope, StatementAgentInstanceFactoryCreateClassForge forge) {
        super(className, packageScope);
        this.forge = forge;
    }

    protected EPTypeClass typeOfFactory() {
        return StatementAgentInstanceFactoryCreateClass.EPTYPE;
    }
