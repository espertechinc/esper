...
public class ContainedEventEvalExprNode implements ContainedEventEval {
    public final static EPTypeClass EPTYPE = new EPTypeClass(ContainedEventEvalExprNode.class);

    private final ExprEvaluator evaluator;
    private final EventBeanFactory eventBeanFactory;

    public ContainedEventEvalExprNode(ExprEvaluator evaluator, EventType eventType, EPStatementInitServices initServices) {
        this.evaluator = evaluator;
        this.eventBeanFactory = EventTypeUtility.getFactoryForType(eventType, initServices.getEventBeanTypedEventFactory(), initServices.getEventTypeAvroHandler());
    }
