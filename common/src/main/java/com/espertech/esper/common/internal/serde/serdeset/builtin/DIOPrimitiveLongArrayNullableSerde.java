...
public class DIOPrimitiveLongArrayNullableSerde implements DataInputOutputSerde<long[]> {
    public final static EPTypeClass EPTYPE = new EPTypeClass(DIOPrimitiveLongArrayNullableSerde.class);

    public final static DIOPrimitiveLongArrayNullableSerde INSTANCE = new DIOPrimitiveLongArrayNullableSerde();

    private DIOPrimitiveLongArrayNullableSerde() {
    }

    public void write(long[] object, DataOutput output) throws IOException {
