...
public class StreamTypeServiceImpl implements StreamTypeService {
     ...
     */
    public StreamTypeServiceImpl(boolean isOnDemandStreams) {
        this(new EventType[0], new String[0], new boolean[0], isOnDemandStreams, false);
    }
     ...
     */
    public StreamTypeServiceImpl(EventType eventType, String streamName, boolean isIStreamOnly) {
        this(new EventType[]{eventType}, new String[]{streamName}, new boolean[]{isIStreamOnly}, false, false);
    }
     ...
     */
    public StreamTypeServiceImpl(EventType[] eventTypes, String[] streamNames, boolean[] isIStreamOnly, boolean isOnDemandStreams, boolean optionalStreams) {
     ...
     */
    public StreamTypeServiceImpl(LinkedHashMap<String, Pair<EventType, String>> namesAndTypes, boolean isStreamZeroUnambigous, boolean requireStreamNames) {
    ...
    public PropertyResolutionDescriptor resolveByStreamAndPropName(String streamAndPropertyName, boolean obtainFragment) throws DuplicatePropertyException, PropertyNotFoundException {
        ...
        try {
            ...
            try {
                ...
                Pair<String, String> propertyNoEnginePair = getIsStreamQualified(propertyName);
    ...
    private Pair<String, String> getIsStreamQualified(String propertyName) {
        ...
        return new Pair<>(propertyNameNoEngine, streamNameNoEngine);
    }
    ...
    private static class PropertyNotFoundExceptionSuggestionGenMultiTyped implements StreamTypesExceptionSuggestionGen {
        ...
        PropertyNotFoundExceptionSuggestionGenMultiTyped(EventType[] eventTypes, String propertyName) {
            this.eventTypes = eventTypes;
    ...
    private static class PropertyNotFoundExceptionSuggestionGenSingleTyped implements StreamTypesExceptionSuggestionGen {
        ...
        PropertyNotFoundExceptionSuggestionGenSingleTyped(EventType eventType, String propertyName) {
    ...
    private static class StreamNotFoundExceptionSuggestionGen implements StreamTypesExceptionSuggestionGen {
        ...
        StreamNotFoundExceptionSuggestionGen(EventType[] eventTypes, String[] streamNames, String streamName) {
            this.eventTypes = eventTypes;
            this.streamNames = streamNames;
        ...
        public Pair<Integer, String> getSuggestion() {
            ...
            if (bestMatchDiff < Integer.MAX_VALUE) {
                suggestion = new Pair<>(bestMatchDiff, bestMatch);
            }
            return suggestion;
        }
    }
