...
public class DIOMultiKeyArrayFloatSerde implements DIOMultiKeyArraySerde<MultiKeyArrayFloat> {
    public final static EPTypeClass EPTYPE = new EPTypeClass(DIOMultiKeyArrayFloatSerde.class);
