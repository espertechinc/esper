...
public class StatementAgentInstanceFactoryOnTriggerInfraMergeForge extends StatementAgentInstanceFactoryOnTriggerInfraBaseForge {
    private final InfraOnMergeHelperForge mergeHelperForge;
    ...
    public EPTypeClass typeOfSubclass() {
        return StatementAgentInstanceFactoryOnTriggerInfraMerge.EPTYPE;
    }
