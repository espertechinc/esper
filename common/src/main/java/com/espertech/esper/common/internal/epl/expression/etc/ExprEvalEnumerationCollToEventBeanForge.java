...
public class ExprEvalEnumerationCollToEventBeanForge implements ExprForge, SelectExprProcessorTypableForge {
    protected final ExprEnumerationForge enumerationForge;
    private final EventType targetType;

    public ExprEvalEnumerationCollToEventBeanForge(ExprEnumerationForge enumerationForge, EventType targetType) {
    ...
    public CodegenExpression evaluateCodegen(EPTypeClass requiredType, CodegenMethodScope codegenMethodScope, ExprForgeCodegenSymbol exprSymbol, CodegenClassScope codegenClassScope) {
        CodegenMethod methodNode = codegenMethodScope.makeChild(EventBean.EPTYPE, ExprEvalEnumerationCollToEventBeanForge.class, codegenClassScope);
        methodNode.getBlock()
