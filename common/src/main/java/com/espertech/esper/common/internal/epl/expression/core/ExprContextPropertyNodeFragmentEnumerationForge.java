...
public class ExprContextPropertyNodeFragmentEnumerationForge implements ExprEnumerationForge {
    private final String propertyName;
    private final EventType fragmentEventType;
    private final EventPropertyGetterSPI getterSPI;

    public ExprContextPropertyNodeFragmentEnumerationForge(String propertyName, EventType fragmentEventType, EventPropertyGetterSPI getterSPI) {
    ...
    public ExprEnumerationEval getExprEvaluatorEnumeration() {
        return new ExprEnumerationEval() {
            ...
            public EventBean evaluateGetEventBean(EventBean[] eventsPerStream, boolean isNewData, ExprEvaluatorContext context) {
                EventBean event = context.getContextProperties();
                if (event == null) {
                    return null;
                }
