...
public class ExprDotMethodForgeNoDuckEvalPlain implements ExprDotEval {
    ...
    public Object evaluate(Object target, EventBean[] eventsPerStream, boolean isNewData, ExprEvaluatorContext exprEvaluatorContext) {
        ...
        try {
            ...
            handleTargetException(forge.getOptionalStatementName(), forge.getMethod().getName(), forge.getMethod().getParameterTypes(), target.getClass().getName(), args, e);
        }
        return null;
    }
     ...
     * @param t                     throwable
     */
    public static void handleTargetException(String optionalStatementName, String methodName, Class[] methodParams, String targetClassName, Object[] args, Throwable t) {
