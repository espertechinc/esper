...
public class DIOCollectionSqlDateNullableSerde implements DataInputOutputSerde<Collection<Date>> {
    public final static EPTypeClass EPTYPE = new EPTypeClass(DIOCollectionSqlDateNullableSerde.class);

    public final static DIOCollectionSqlDateNullableSerde INSTANCE = new DIOCollectionSqlDateNullableSerde();

    private DIOCollectionSqlDateNullableSerde() {
    }
