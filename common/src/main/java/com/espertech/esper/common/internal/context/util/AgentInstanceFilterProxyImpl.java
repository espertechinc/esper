...
public class AgentInstanceFilterProxyImpl implements AgentInstanceFilterProxy {
    ...
    private Supplier<IdentityHashMap<FilterSpecActivatable, FilterValueSetParam[][]>> generator;
    private Map<FilterSpecActivatable, FilterValueSetParam[][]> addendumMap;

    public AgentInstanceFilterProxyImpl(Supplier<IdentityHashMap<FilterSpecActivatable, FilterValueSetParam[][]>> generator) {
