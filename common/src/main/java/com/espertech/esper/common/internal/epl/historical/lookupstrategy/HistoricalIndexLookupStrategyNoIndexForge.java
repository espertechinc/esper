 ...
 */
public class HistoricalIndexLookupStrategyNoIndexForge implements HistoricalIndexLookupStrategyForge {

    public final static HistoricalIndexLookupStrategyNoIndexForge INSTANCE = new HistoricalIndexLookupStrategyNoIndexForge();
    ...
    public CodegenExpression make(CodegenMethodScope method, SAIFFInitializeSymbol symbols, CodegenClassScope classScope) {
        return publicConstValue(HistoricalIndexLookupStrategyNoIndex.class, "INSTANCE");
    }
