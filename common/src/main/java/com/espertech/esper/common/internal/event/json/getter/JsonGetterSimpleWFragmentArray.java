 ...
 */
public class JsonGetterSimpleWFragmentArray extends JsonGetterSimpleBase {

    public JsonGetterSimpleWFragmentArray(JsonUnderlyingField field, String underlyingClassName, EventType fragmentType, EventBeanTypedEventFactory eventBeanTypedEventFactory) {
    ...
    public CodegenExpression underlyingFragmentCodegen(CodegenExpression underlyingExpression, CodegenMethodScope codegenMethodScope, CodegenClassScope codegenClassScope) {
        ...
        return staticMethod(JsonFieldGetterHelper.class, "handleJsonCreateFragmentArray", underlyingExpression, constant(field.getPropertyNumber()), eventType, factory);
    }
    ...
    public Object getJsonFragment(Object object) throws PropertyAccessException {
        ...
        return JsonFieldGetterHelper.handleJsonCreateFragmentArray((JsonEventObjectBase) object, field.getPropertyNumber(), fragmentType, eventBeanTypedEventFactory);
    }
}
