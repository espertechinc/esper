...
public class ExprCastNode extends ExprNodeBase {
    ...
    public ExprNode validate(ExprValidationContext validationContext) throws ExprValidationException {
        ...
        EPType fromTypeMayNull = fromType == null ? EPTypeNull.INSTANCE : fromType; // evaluation types are never null but are EPTypeNull.INSTANCE, this is a safety-check
        ...
        if (classIdentifierWArray.getTypeParameters().isEmpty()) {
            clazzSimpleNamed = JavaClassHelper.getPrimitiveClassForName(classIdentifierWArray.getClassIdentifier().trim());
        }
        ...
        String classIdentifierLower = classIdentifierWArray.getClassIdentifier().trim().toLowerCase(Locale.ENGLISH);
        if (dateFormatParameter != null) {
            if (!isTypeString(fromTypeMayNull)) {
            ...
            if (targetType == null) {
                try {
                    Class targetClass = JavaClassHelper.getClassForName(classIdentifierWArray.getClassIdentifier().trim(), validationContext.getClasspathImportService().getClassForNameProvider());
                    targetType = applyDimensions(EPTypePremade.getOrCreate(targetClass));
                    // expected
            ...
            } else if ((targetType != null && targetType.getType() == ZonedDateTime.class) || classIdentifierLower.equals("zoneddatetime")) {
            ...
            targetType = JavaClassHelper.getBoxedType(targetType);
            caster = SimpleTypeCasterFactory.getCaster(fromTypeMayNull, targetType);
            ...
            targetType = ClasspathImportEPTypeUtil.resolveClassIdentifierToEPType(classIdentifierWArray, false, validationContext.getClasspathImportService(), validationContext.getClassProvidedClasspathExtension());
            if (targetType == null) {
        ...
        if (casterParserComputerForge == null) {
            ...
            } else if (isTypeString(fromTypeMayNull) && targetType.getType() != Character.class) {
                // parse
    ...
    public Class getTargetType() {
        checkValidated(forge);
        return forge.getEvaluationType().getType();
    }
    ...
    public static class NumberCasterComputer implements CasterParserComputerForge, CasterParserComputer {
        ...
        public CodegenExpression codegenPremade(EPTypeClass evaluationType, CodegenExpression input, EPTypeClass inputType, CodegenMethodScope codegenMethodScope, ExprForgeCodegenSymbol exprSymbol, CodegenClassScope codegenClassScope) {
            if (inputType.getType().isPrimitive() || JavaClassHelper.isSubclassOrImplementsInterface(inputType, Number.class)) {
            ...
            methodNode.getBlock()
                    .ifInstanceOf("input", EPTypePremade.NUMBER.getEPType())
    ...
    public abstract static class StringToJava8WStaticFormatComputer implements CasterParserComputerForge, CasterParserComputer {
        ...
        protected CodegenExpression codegenFormatter(CodegenClassScope codegenClassScope) {
            return codegenClassScope.addFieldUnshared(true, EPTypePremade.DATETIMEFORMATTER.getEPType(), staticMethod(DateTimeFormatter.class, "ofPattern", constant(format)));
        }
    ...
    public static class StringToLocalDateTimeWExprFormatComputerEval extends StringToJava8WExprFormatComputerEval {
        ...
        public static CodegenExpression codegen(CodegenExpression input, ExprForge dateFormatForge, CodegenMethodScope codegenMethodScope, ExprForgeCodegenSymbol exprSymbol, CodegenClassScope codegenClassScope) {
            CodegenMethod method = codegenMethodScope.makeChild(EPTypePremade.LOCALDATETIME.getEPType(), StringToLocalDateTimeWExprFormatComputerEval.class, codegenClassScope).addParam(EPTypePremade.STRING.getEPType(), "input");
            CodegenExpression formatter;
            if (dateFormatForge.getForgeConstantType().isConstant()) {
                formatter = formatFieldExpr(EPTypePremade.DATETIMEFORMATTER.getEPType(), dateFormatForge, codegenClassScope);
            } else {
                method.getBlock().declareVar(EPTypePremade.DATETIMEFORMATTER.getEPType(), "formatter", staticMethod(ExprCastNode.class, "stringToDateTimeFormatterSafe", dateFormatForge.evaluateCodegen(EPTypePremade.OBJECT.getEPType(), method, exprSymbol, codegenClassScope)));
    ...
    public static class StringToLocalDateWExprFormatComputerEval extends StringToJava8WExprFormatComputerEval {
        ...
        public static CodegenExpression codegen(CodegenExpression input, ExprForge dateFormatForge, CodegenMethodScope codegenMethodScope, ExprForgeCodegenSymbol exprSymbol, CodegenClassScope codegenClassScope) {
            CodegenMethod method = codegenMethodScope.makeChild(EPTypePremade.LOCALDATE.getEPType(), StringToLocalDateWExprFormatComputerEval.class, codegenClassScope).addParam(EPTypePremade.STRING.getEPType(), "input");
            CodegenExpression format;
            if (dateFormatForge.getForgeConstantType().isConstant()) {
                format = formatFieldExpr(EPTypePremade.DATETIMEFORMATTER.getEPType(), dateFormatForge, codegenClassScope);
            } else {
                method.getBlock()
                        .declareVar(EPTypePremade.DATETIMEFORMATTER.getEPType(), "formatter", staticMethod(ExprCastNode.class, "stringToDateTimeFormatterSafe", dateFormatForge.evaluateCodegen(EPTypePremade.OBJECT.getEPType(), method, exprSymbol, codegenClassScope)));
    ...
    public static class StringToLocalTimeWExprFormatComputerEval extends StringToJava8WExprFormatComputerEval {
        ...
        public static CodegenExpression codegen(CodegenExpression input, ExprForge dateFormatForge, CodegenMethodScope codegenMethodScope, ExprForgeCodegenSymbol exprSymbol, CodegenClassScope codegenClassScope) {
            CodegenMethod methodNode = codegenMethodScope.makeChild(EPTypePremade.LOCALTIME.getEPType(), StringToLocalTimeWExprFormatComputerForge.class, codegenClassScope).addParam(EPTypePremade.STRING.getEPType(), "input");
            ...
            if (dateFormatForge.getForgeConstantType().isConstant()) {
                ...
                methodNode.getBlock()
                        .declareVar(EPTypePremade.DATETIMEFORMATTER.getEPType(), "formatter", staticMethod(ExprCastNode.class, "stringToDateTimeFormatterSafe", dateFormatForge.evaluateCodegen(EPTypePremade.OBJECT.getEPType(), methodNode, exprSymbol, codegenClassScope)));
                format = ref("formatter");
            }
            methodNode.getBlock()
    ...
    public static class StringToZonedDateTimeWExprFormatComputerEval extends StringToJava8WExprFormatComputerEval {
        ...
        public static CodegenExpression codegen(CodegenExpression input, ExprForge dateFormatForge, CodegenMethodScope codegenMethodScope, ExprForgeCodegenSymbol exprSymbol, CodegenClassScope codegenClassScope) {
            CodegenMethod methodNode = codegenMethodScope.makeChild(EPTypePremade.ZONEDDATETIME.getEPType(), StringToZonedDateTimeWExprFormatComputerEval.class, codegenClassScope).addParam(EPTypePremade.STRING.getEPType(), "input");
            CodegenExpression format;
            if (dateFormatForge.getForgeConstantType().isConstant()) {
                format = formatFieldExpr(EPTypePremade.DATETIMEFORMATTER.getEPType(), dateFormatForge, codegenClassScope);
            } else {
    ...
    public static class StringToDateExprFormatComputerEval extends StringToDateLongWExprormatEval {
        ...
        public static CodegenExpression codegen(CodegenExpression input, ExprForge formatExpr, CodegenMethodScope codegenMethodScope, ExprForgeCodegenSymbol exprSymbol, CodegenClassScope codegenClassScope) {
            CodegenMethod method = codegenMethodScope.makeChild(EPTypePremade.DATE.getEPType(), StringToDateExprFormatComputerEval.class, codegenClassScope).addParam(EPTypePremade.OBJECT.getEPType(), "input");
            CodegenExpression dateFormat;
            if (formatExpr.getForgeConstantType().isConstant()) {
                dateFormat = formatFieldExpr(EPTypePremade.DATEFORMAT.getEPType(), formatExpr, codegenClassScope);
            } else {
                method.getBlock()
                        .declareVar(EPTypePremade.OBJECT.getEPType(), "format", formatExpr.evaluateCodegen(EPTypePremade.OBJECT.getEPType(), method, exprSymbol, codegenClassScope))
                        .declareVar(EPTypePremade.SIMPLEDATEFORMAT.getEPType(), "dateFormat", staticMethod(ExprCastNode.class, "stringToSimpleDateFormatSafe", ref("format")));
    ...
    public static class StringToLongWExprFormatComputerEval extends StringToDateLongWExprormatEval {
        ...
        public static CodegenExpression codegen(CodegenExpression input, ExprForge formatForge, CodegenMethodScope codegenMethodScope, ExprForgeCodegenSymbol exprSymbol, CodegenClassScope codegenClassScope) {
            CodegenMethod method = codegenMethodScope.makeChild(EPTypePremade.LONGBOXED.getEPType(), StringToLongWExprFormatComputerEval.class, codegenClassScope).addParam(EPTypePremade.OBJECT.getEPType(), "input");
            CodegenExpression format;
            if (formatForge.getForgeConstantType().isConstant()) {
                format = formatFieldExpr(EPTypePremade.DATEFORMAT.getEPType(), formatForge, codegenClassScope);
            } else {
                method.getBlock()
                        .declareVar(EPTypePremade.OBJECT.getEPType(), "format", formatForge.evaluateCodegen(EPTypePremade.OBJECT.getEPType(), method, exprSymbol, codegenClassScope))
                        .declareVar(EPTypePremade.SIMPLEDATEFORMAT.getEPType(), "dateFormat", staticMethod(ExprCastNode.class, "stringToSimpleDateFormatSafe", ref("format")));
    ...
    public static class StringToCalendarWExprFormatComputerEval extends StringToDateLongWExprormatEval {
        ...
        public static CodegenExpression codegen(CodegenExpression input, ExprForge dateFormatForge, CodegenMethodScope codegenMethodScope, ExprForgeCodegenSymbol exprSymbol, CodegenClassScope codegenClassScope, TimeZone timeZone) {
            CodegenExpression timeZoneField = codegenClassScope.addOrGetFieldSharable(RuntimeSettingsTimeZoneField.INSTANCE);
            CodegenMethod method = codegenMethodScope.makeChild(EPTypePremade.CALENDAR.getEPType(), StringToCalendarWExprFormatComputerEval.class, codegenClassScope).addParam(EPTypePremade.OBJECT.getEPType(), "input");
            CodegenExpression format;
            if (dateFormatForge.getForgeConstantType().isConstant()) {
                format = formatFieldExpr(EPTypePremade.DATEFORMAT.getEPType(), dateFormatForge, codegenClassScope);
            } else {
                method.getBlock()
                        .declareVar(EPTypePremade.OBJECT.getEPType(), "format", dateFormatForge.evaluateCodegen(EPTypePremade.OBJECT.getEPType(), method, exprSymbol, codegenClassScope))
                        .declareVar(EPTypePremade.SIMPLEDATEFORMAT.getEPType(), "dateFormat", staticMethod(ExprCastNode.class, "stringToSimpleDateFormatSafe", ref("format")));
                format = ref("dateFormat");
            }
    ...
    private ExprCastNodeDateDesc validateDateFormat(ExprNamedParameterNode dateFormatParameter, ExprValidationContext validationContext, boolean java8Formatter) throws ExprValidationException {
        ...
        if (typeClass.getType() == String.class) {
            ...
            if (!java8Formatter) {
                if (!JavaClassHelper.isSubclassOrImplementsInterface(typeClass, DateFormat.class)) {
                    throw getFailedExpected(DateFormat.class, formatReturnType);
                }
            } else {
                if (!JavaClassHelper.isSubclassOrImplementsInterface(typeClass, DateTimeFormatter.class)) {
    ...
    private static CodegenExpression formatFieldJava7(String dateFormatString, CodegenClassScope codegenClassScope) {
        return codegenClassScope.addFieldUnshared(true, EPTypePremade.DATEFORMAT.getEPType(), newInstance(EPTypePremade.SIMPLEDATEFORMAT.getEPType(), constant(dateFormatString)));
    }

    private static CodegenExpression formatFieldJava8(String dateFormatString, CodegenClassScope codegenClassScope) {
        return codegenClassScope.addFieldUnshared(true, EPTypePremade.STRING.getEPType(), staticMethod(DateTimeFormatter.class, "ofPattern", constant(dateFormatString)));
    }
