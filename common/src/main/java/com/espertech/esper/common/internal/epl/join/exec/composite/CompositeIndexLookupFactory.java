...
public class CompositeIndexLookupFactory {
    ...
    public static CompositeIndexLookup make(Object[] keyValues, MultiKeyFromObjectArray multiKeyTransform, RangeIndexLookupValue[] rangeValues, Class[] rangeCoercion) {
        // construct chain
