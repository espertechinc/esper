...
public class StmtClassForgableAIFactoryProviderCreateDataflow extends StmtClassForgableAIFactoryProviderBase {
    private final StatementAgentInstanceFactoryCreateDataflowForge forge;

    public StmtClassForgableAIFactoryProviderCreateDataflow(String className, CodegenPackageScope packageScope, StatementAgentInstanceFactoryCreateDataflowForge forge) {
