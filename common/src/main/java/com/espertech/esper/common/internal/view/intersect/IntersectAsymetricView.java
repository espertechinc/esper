 ...
 */
public class IntersectAsymetricView extends ViewSupport implements LastPostObserver, AgentInstanceStopCallback, DataWindowView, ViewDataVisitableContainer, IntersectViewMarker {
    protected final AgentInstanceContext agentInstanceContext;
    private final IntersectViewFactory factory;
    protected final View[] views;

    public IntersectAsymetricView(AgentInstanceViewFactoryChainContext agentInstanceContext, IntersectViewFactory factory, List<View> viewList) {
    ...
    public void update(EventBean[] newData, EventBean[] oldData) {
        ...
        if ((newDataPosted != null) || (oldDataPosted != null)) {
            agentInstanceContext.getInstrumentationProvider().qViewIndicate(factory, newDataPosted, oldDataPosted);
