...
public class ExprEvalEnumerationEventBeanToEventBeanArrayForge implements ExprForge, SelectExprProcessorTypableForge {
    protected final ExprEnumerationForge enumerationForge;
    private final EventType targetType;

    public ExprEvalEnumerationEventBeanToEventBeanArrayForge(ExprEnumerationForge enumerationForge, EventType targetType) {
    ...
    public CodegenExpression evaluateCodegen(EPTypeClass requiredType, CodegenMethodScope codegenMethodScope, ExprForgeCodegenSymbol exprSymbol, CodegenClassScope codegenClassScope) {
        CodegenMethod methodNode = codegenMethodScope.makeChild(EventBean.EPTYPEARRAY, ExprEvalEnumerationEventBeanToEventBeanArrayForge.class, codegenClassScope);
