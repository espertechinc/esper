...
public class EPAssertionUtil {
     ...
     *
     * @param lastData       array of events
     * @param namesAndValues array of pairs with the first element the event property name and the second element the expected value
     */
