...
public class EnumSelectFromScalarIndexForgeEval implements EnumEval {

    private final EnumSelectFromScalarIndexForge forge;
    private final ExprEvaluator innerExpression;

    public EnumSelectFromScalarIndexForgeEval(EnumSelectFromScalarIndexForge forge, ExprEvaluator innerExpression) {
        this.forge = forge;
    ...
    public static CodegenExpression codegen(EnumSelectFromScalarIndexForge forge, EnumForgeCodegenParams args, CodegenMethodScope codegenMethodScope, CodegenClassScope codegenClassScope) {
        ...
        CodegenMethod methodNode = codegenMethodScope.makeChildWithScope(Collection.class, EnumSelectFromScalarIndexForgeEval.class, scope, codegenClassScope).addParam(EnumForgeCodegenNames.PARAMS);
