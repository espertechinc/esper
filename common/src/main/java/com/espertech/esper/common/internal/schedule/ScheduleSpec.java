...
public final class ScheduleSpec {
    ...
    public CodegenExpression make(CodegenMethodScope parent, CodegenClassScope classScope) {
        ...
        for (ScheduleUnit unit : unitValues.keySet()) {
        ...
        if (optionalDayOfWeekOperator != null) {
            method.getBlock().exprDotMethod(spec, "setOptionalDayOfWeekOperator", optionalDayOfWeekOperator.make());
        }
        if (optionalDayOfMonthOperator != null) {
            method.getBlock().exprDotMethod(spec, "setOptionalDayOfMonthOperator", optionalDayOfMonthOperator.make());
        }
