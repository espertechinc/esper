...
public class ModuleNamedWindowInitializeSymbol implements CodegenSymbolProvider {
    public final static CodegenExpressionRef REF_INITSVC = ref("moduleNWInitSvc");
    ...
    public void provide(Map<String, EPTypeClass> symbols) {
        if (optionalInitServicesRef != null) {
            symbols.put(optionalInitServicesRef.getRef(), EPModuleNamedWindowInitServices.EPTYPE);
        }
    }
}
