...
public class AggregatorStddev extends AggregatorMethodWDistinctWFilterWValueBase {
    ...
    public AggregatorStddev(AggregationForgeFactory factory, int col, CodegenCtor rowCtor, CodegenMemberCol membersColumnized, CodegenClassScope classScope, Class optionalDistinctValueType, boolean hasFilter, ExprNode optionalFilter) {
