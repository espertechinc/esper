 ...
 */
public class RegressionLinestViewForge extends ViewFactoryForgeBaseDerived {
    ...
    public EPTypeClass typeOfFactory() {
        return RegressionLinestViewFactory.EPTYPE;
    }
    ...
    public AppliesTo appliesTo() {
        return AppliesTo.WINDOW_REGRESSIONLINEST;
    }
