...
import com.espertech.esper.common.internal.collection.RollingTwoValueBuffer;
...
public class ExpressionResultCacheForDeclaredExprLastValueMulti implements ExpressionResultCacheForDeclaredExprLastValue {
    ...
    private final HashMap<Object, SoftReference<RollingTwoValueBuffer<EventBean[], Object>>> cache
            = new HashMap<Object, SoftReference<RollingTwoValueBuffer<EventBean[], Object>>>();
