...
public class StmtClassForgeableAIFactoryProviderCreateSchema extends StmtClassForgeableAIFactoryProviderBase {
    private final StatementAgentInstanceFactoryCreateSchemaForge forge;

    public StmtClassForgeableAIFactoryProviderCreateSchema(String className, CodegenPackageScope packageScope, StatementAgentInstanceFactoryCreateSchemaForge forge) {
        super(className, packageScope);
        this.forge = forge;
    }

    protected EPTypeClass typeOfFactory() {
        return StatementAgentInstanceFactoryCreateSchema.EPTYPE;
    }
