...
public class StmtClassForgableAIFactoryProviderCreateTable extends StmtClassForgableAIFactoryProviderBase {
    private final StatementAgentInstanceFactoryCreateTableForge forge;
    private final String tableName;

    public StmtClassForgableAIFactoryProviderCreateTable(String className, CodegenPackageScope packageScope, StatementAgentInstanceFactoryCreateTableForge forge, String tableName) {
