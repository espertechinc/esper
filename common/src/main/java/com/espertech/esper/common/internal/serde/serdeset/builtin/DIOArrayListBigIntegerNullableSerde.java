...
public class DIOArrayListBigIntegerNullableSerde implements DataInputOutputSerde<Collection<BigInteger>> {
    public final static EPTypeClass EPTYPE = new EPTypeClass(DIOArrayListBigIntegerNullableSerde.class);

    public final static DIOArrayListBigIntegerNullableSerde INSTANCE = new DIOArrayListBigIntegerNullableSerde();

    private DIOArrayListBigIntegerNullableSerde() {
    }
