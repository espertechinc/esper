 ...
 */
public class ConfigurationCompilerPlugInSingleRowFunction implements Serializable {
     ...
     */
    public ConfigurationCompilerPlugInSingleRowFunction(String name, String functionClassName, String functionMethodName, ValueCache valueCache, FilterOptimizable filterOptimizable, boolean rethrowExceptions, String eventTypeName) {
        this.name = name;
