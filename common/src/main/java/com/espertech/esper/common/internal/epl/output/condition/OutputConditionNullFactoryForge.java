...
public class OutputConditionNullFactoryForge implements OutputConditionFactoryForge {

    public final static OutputConditionNullFactoryForge INSTANCE = new OutputConditionNullFactoryForge();
    ...
    public CodegenExpression make(CodegenMethodScope method, SAIFFInitializeSymbol symbols, CodegenClassScope classScope) {
        return publicConstValue(OutputConditionNullFactory.class, "INSTANCE");
    }
