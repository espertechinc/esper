...
public class AgregationTAAReaderCountMinSketchTopKForge implements AggregationTableAccessAggReaderForge {
    ...
    public CodegenExpression codegenCreateReader(CodegenMethodScope parent, SAIFFInitializeSymbol symbols, CodegenClassScope classScope) {
        CodegenMethod method = parent.makeChild(AgregationTAAReaderCountMinSketchTopK.class, this.getClass(), classScope);
        method.getBlock()
                .declareVar(AgregationTAAReaderCountMinSketchTopK.class, "strat", newInstance(AgregationTAAReaderCountMinSketchTopK.class))
