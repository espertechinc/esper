...
public class AggregationTAAReaderLinearFirstLastIndexForge implements AggregationTableAccessAggReaderForge {
    ...
    public AggregationTAAReaderLinearFirstLastIndexForge(Class underlyingType, AggregationAccessorLinearType accessType, Integer optionalConstant, ExprNode optionalIndexEval) {
    ...
    public CodegenExpression codegenCreateReader(CodegenMethodScope parent, SAIFFInitializeSymbol symbols, CodegenClassScope classScope) {
        CodegenMethod method = parent.makeChild(AggregationTAAReaderLinearFirstLastIndex.class, this.getClass(), classScope);
        method.getBlock()
                .declareVar(AggregationTAAReaderLinearFirstLastIndex.class, "strat", newInstance(AggregationTAAReaderLinearFirstLastIndex.class))
