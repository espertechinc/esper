...
public class StmtClassForgableStmtProvider implements StmtClassForgable {
    ...
    public StmtClassForgableStmtProvider(String statementAIFactoryClassName, String statementProviderClassName, StatementInformationalsCompileTime statementInformationals, CodegenPackageScope packageScope) {
    ...
    public CodegenClass forge(boolean includeDebugSymbols) {
        ...
        CodegenMethod getStatementInformationalsMethod = CodegenMethod.makeParentNode(StatementInformationalsRuntime.class, StmtClassForgableStmtProvider.class, CodegenSymbolProviderEmpty.INSTANCE, classScope)
    ...
    public StmtClassForgableType getForgableType() {
        return StmtClassForgableType.STMTPROVIDER;
    }

    private CodegenMethod makeInitialize(CodegenClassScope classScope) {
        CodegenMethod method = CodegenMethod.makeParentNode(void.class, StmtClassForgableStmtProvider.class, classScope).addParam(EPStatementInitServices.class, REF_STMTINITSVC.getRef());
    ...
    private static CodegenMethod makeGetStatementAIFactoryProvider(CodegenClassScope classScope) {
        CodegenMethod method = CodegenMethod.makeParentNode(StatementAIFactoryProvider.class, StmtClassForgableStmtProvider.class, CodegenSymbolProviderEmpty.INSTANCE, classScope);
