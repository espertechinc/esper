...
import static com.espertech.esper.common.internal.epl.enummethod.eval.EnumTakeWhileLastIndexScalarForgeEval.METHOD_TAKEWHILELASTSCALARTOARRAY;
import static com.espertech.esper.common.internal.epl.enummethod.eval.EnumTakeWhileLastIndexScalarForgeEval.takeWhileLastScalarToArray;
...
public class EnumTakeWhileLastScalarForgeEval implements EnumEval {
    ...
    public static CodegenExpression codegen(EnumTakeWhileLastScalarForge forge, EnumForgeCodegenParams args, CodegenMethodScope codegenMethodScope, CodegenClassScope codegenClassScope) {
        ...
        CodegenMethod methodNode = codegenMethodScope.makeChildWithScope(Collection.class, EnumTakeWhileLastScalarForgeEval.class, scope, codegenClassScope).addParam(EnumForgeCodegenNames.PARAMS);
        ...
        block.declareVar(ObjectArrayEventBean.class, "evalEvent", newInstance(ObjectArrayEventBean.class, newArrayByLength(Object.class, constant(1)), typeMember))
