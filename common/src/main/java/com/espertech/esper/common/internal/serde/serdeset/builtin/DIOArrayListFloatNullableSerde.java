...
public class DIOArrayListFloatNullableSerde implements DataInputOutputSerde<Collection<Float>> {
    public final static EPTypeClass EPTYPE = new EPTypeClass(DIOArrayListFloatNullableSerde.class);

    public final static DIOArrayListFloatNullableSerde INSTANCE = new DIOArrayListFloatNullableSerde();

    private DIOArrayListFloatNullableSerde() {
    }
