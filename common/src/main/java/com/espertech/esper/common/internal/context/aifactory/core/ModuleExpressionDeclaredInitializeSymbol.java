...
public class ModuleExpressionDeclaredInitializeSymbol implements CodegenSymbolProvider {
    public final static CodegenExpressionRef REF_INITSVC = ref("moduleDeclInitSvc");
    ...
    public void provide(Map<String, EPTypeClass> symbols) {
        if (optionalInitServicesRef != null) {
            symbols.put(optionalInitServicesRef.getRef(), EPModuleExprDeclaredInitServices.EPTYPE);
        }
    }
}
