...
public class DIOArrayListDateNullableSerde implements DataInputOutputSerde<Collection<Date>> {
    public final static EPTypeClass EPTYPE = new EPTypeClass(DIOArrayListDateNullableSerde.class);

    public final static DIOArrayListDateNullableSerde INSTANCE = new DIOArrayListDateNullableSerde();

    private DIOArrayListDateNullableSerde() {
    }
