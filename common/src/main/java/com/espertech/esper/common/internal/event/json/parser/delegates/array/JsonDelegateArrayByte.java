...
public class JsonDelegateArrayByte extends JsonDelegateArrayBase {
    public final static EPTypeClass EPTYPE = new EPTypeClass(JsonDelegateArrayByte.class);
    public JsonDelegateArrayByte(JsonHandlerDelegator baseHandler, JsonDelegateBase parent) {
