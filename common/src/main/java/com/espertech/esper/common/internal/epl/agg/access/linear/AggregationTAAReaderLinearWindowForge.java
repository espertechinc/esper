...
public class AggregationTAAReaderLinearWindowForge implements AggregationTableAccessAggReaderForge {
    private final Class arrayType;
    private final ExprNode optionalEvaluator;

    public AggregationTAAReaderLinearWindowForge(Class arrayType, ExprNode optionalEvaluator) {
    ...
    public CodegenExpression codegenCreateReader(CodegenMethodScope parent, SAIFFInitializeSymbol symbols, CodegenClassScope classScope) {
        CodegenMethod method = parent.makeChild(AggregationTAAReaderLinearWindow.class, this.getClass(), classScope);
        method.getBlock()
                .declareVar(AggregationTAAReaderLinearWindow.class, "strat", newInstance(AggregationTAAReaderLinearWindow.class))
