...
public class AggregationMethodCountMinSketchFreq implements AggregationMultiFunctionAggregationMethod {
    public final static EPTypeClass EPTYPE = new EPTypeClass(AggregationMethodCountMinSketchFreq.class);
