...
public class ModuleContextInitializeSymbol implements CodegenSymbolProvider {
    public final static CodegenExpressionRef REF_INITSVC = ref("moduleCtxInitSvc");
    ...
    public void provide(Map<String, EPTypeClass> symbols) {
        if (optionalInitServicesRef != null) {
            symbols.put(optionalInitServicesRef.getRef(), EPModuleContextInitServices.EPTYPE);
        }
    }
}
