...
public class IntervalForgeImpl implements IntervalForge {
    ...
    public IntervalForgeImpl(DatetimeMethodDesc method, String methodNameUse, StreamTypeService streamTypeService, List<ExprNode> expressions, TimeAbacus timeAbacus, TableCompileTimeResolver tableCompileTimeResolver)
        ...
        if (expressions.get(0) instanceof ExprStreamUnderlyingNode) {
            ...
            if (!JavaClassHelper.isDatetimeClass(forgeTimestamp.getEvaluationType())) {
                ...
                if (unresolvedPropertyName != null) {
                    Pair<PropertyResolutionDescriptor, String> propertyDesc = ExprIdentNodeUtil.getTypeFromStream(streamTypeService, unresolvedPropertyName, false, true, tableCompileTimeResolver);
        ...
        if (forgeEndTimestamp == null) {
            if (JavaClassHelper.isSubclassOrImplementsInterface(timestampType, Calendar.class)) {
                ...
                intervalOpForge = new IntervalOpLocalDateTimeForge(intervalComputerForge);
            ...
            if (JavaClassHelper.isSubclassOrImplementsInterface(timestampType, Calendar.class)) {
                ...
                intervalOpForge = new IntervalOpLocalDateTimeWithEndForge(intervalComputerForge, forgeEndTimestamp);
            } else if (JavaClassHelper.isSubclassOrImplementsInterface(timestampType, ZonedDateTime.class)) {
    ...
    public static class IntervalOpLocalDateTimeForge extends IntervalOpForgeBase {
        ...
        public IntervalOpLocalDateTimeForge(IntervalComputerForge intervalComputer) {
            super(intervalComputer);
        }
    ...
    public static class IntervalOpDateWithEndForge extends IntervalOpForgeDateWithEndBase {
        ...
        protected CodegenExpression codegenEvaluate(CodegenExpressionRef startTs, CodegenExpressionRef endTs, CodegenExpressionRef paramStartTs, CodegenExpressionRef paramEndTs, CodegenMethod parentNode, ExprForgeCodegenSymbol exprSymbol, CodegenClassScope codegenClassScope) {
    ...
    public static class IntervalOpLocalDateTimeWithEndForge extends IntervalOpForgeDateWithEndBase {
        ...
        public IntervalOpLocalDateTimeWithEndForge(IntervalComputerForge intervalComputer, ExprForge evaluatorEndTimestamp) {
            super(intervalComputer, evaluatorEndTimestamp);
        }

        public IntervalOpEval makeEval() {
            return new IntervalOpLocalDateTimeWithEndEval(intervalComputer.makeComputerEval(), forgeEndTimestamp.getExprEvaluator(), TimeZone.getDefault());
        }

        protected CodegenExpression codegenEvaluate(CodegenExpressionRef startTs, CodegenExpressionRef endTs, CodegenExpressionRef paramStartTs, CodegenExpressionRef paramEndTs, CodegenMethod parentNode, ExprForgeCodegenSymbol exprSymbol, CodegenClassScope codegenClassScope) {
            CodegenExpression timeZoneField = codegenClassScope.addOrGetFieldSharable(RuntimeSettingsTimeZoneField.INSTANCE);
            return intervalComputer.codegen(startTs, endTs,
                    staticMethod(DatetimeLongCoercerLocalDateTime.class, "coerceLDTToMilliWTimezone", paramStartTs, timeZoneField),
                    staticMethod(DatetimeLongCoercerLocalDateTime.class, "coerceLDTToMilliWTimezone", paramEndTs, timeZoneField),
