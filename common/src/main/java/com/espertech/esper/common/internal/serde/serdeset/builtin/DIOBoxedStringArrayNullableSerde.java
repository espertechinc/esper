...
public class DIOBoxedStringArrayNullableSerde implements DataInputOutputSerde<String[]> {
    public final static DIOBoxedStringArrayNullableSerde INSTANCE = new DIOBoxedStringArrayNullableSerde();

    private DIOBoxedStringArrayNullableSerde() {
    }
