...
public class EnumFirstOfEventPlus extends ThreeFormEventPlus {

    public EnumFirstOfEventPlus(ExprDotEvalParamLambda lambda, ObjectArrayEventType indexEventType, int numParameters) {
