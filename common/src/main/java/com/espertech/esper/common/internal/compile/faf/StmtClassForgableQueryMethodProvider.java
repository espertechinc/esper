...
public class StmtClassForgableQueryMethodProvider implements StmtClassForgable {
    ...
    public CodegenClass forge(boolean includeDebugSymbols) {
        ...
        try {
            ...
            StmtClassForgableStmtFields.makeSubstitutionSetter(packageScope, getSubstitutionFieldSetter, classScope);
            ...
            // render and compile
            return new CodegenClass(FAFQueryMethodProvider.class, packageScope.getPackageName(), className, classScope, providerExplicitMembers, providerCtor, methods, innerClasses);
        } catch (Throwable t) {
    ...
    public StmtClassForgableType getForgableType() {
        return StmtClassForgableType.FAF;
    }
}
