...
public class StmtClassForgableAIFactoryProviderCreateContext extends StmtClassForgableAIFactoryProviderBase {
    ...
    public StmtClassForgableAIFactoryProviderCreateContext(String className, CodegenPackageScope packageScope, String contextName, ContextControllerFactoryForge[] forges, EventType eventTypeContextProperties, StatementAgentInstanceFactoryCreateContextForge forge) {
