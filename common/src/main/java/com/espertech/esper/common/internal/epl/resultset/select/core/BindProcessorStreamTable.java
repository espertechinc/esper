...
public class BindProcessorStreamTable implements ExprForge, ExprEvaluator, ExprNodeRenderable {
    private final int streamNum;
    private final EPTypeClass returnType;
    private final TableMetaData tableMetadata;

    public BindProcessorStreamTable(int streamNum, EPTypeClass returnType, TableMetaData tableMetadata) {
    ...
    public CodegenExpression evaluateCodegen(EPTypeClass requiredType, CodegenMethodScope codegenMethodScope, ExprForgeCodegenSymbol exprSymbol, CodegenClassScope codegenClassScope) {
        ...
        return staticMethod(BindProcessorStreamTable.class, "evaluateConvertTableEventToUnd", constant(streamNum), eventToPublic, refEPS, refIsNewData, refExprEvalCtx);
    }
