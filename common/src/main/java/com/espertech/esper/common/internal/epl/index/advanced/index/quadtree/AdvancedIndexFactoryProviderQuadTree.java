...
import static com.espertech.esper.common.internal.epl.index.advanced.index.quadtree.AdvancedIndexQuadTreeConstants.*;
import static com.espertech.esper.common.internal.epl.index.advanced.index.service.AdvancedIndexEvaluationHelper.*;
import static com.espertech.esper.common.internal.epl.index.advanced.index.service.AdvancedIndexValidationHelper.*;
...
public abstract class AdvancedIndexFactoryProviderQuadTree implements AdvancedIndexFactoryProvider {
    ...
    protected static void validateParameters(String indexTypeName, ExprNode[] parameters) throws ExprValidationException {
        ...
        if (parameters.length > 4) {
            validateParameterReturnType(Integer.class, indexTypeName, 4, parameters[4], PARAM_LEAFCAPACITY);
        }
        if (parameters.length > 5) {
            validateParameterReturnType(Integer.class, indexTypeName, 5, parameters[5], PARAM_MAXTREEHEIGHT);
        }
    }
