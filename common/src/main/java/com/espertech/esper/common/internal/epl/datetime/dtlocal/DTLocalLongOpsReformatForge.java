...
public class DTLocalLongOpsReformatForge extends DTLocalForgeCalopReformatBase {
    ...
    public DTLocalLongOpsReformatForge(List<CalendarForge> calendarForges, ReformatForge reformatForge, TimeAbacus timeAbacus) {
        super(calendarForges, reformatForge);
        this.timeAbacus = timeAbacus;
    }

    public DTLocalEvaluator getDTEvaluator() {
        return new DTLocalLongOpsReformatEval(getCalendarOps(calendarForges), reformatForge.getOp(), TimeZone.getDefault(), timeAbacus);
    }
