...
public class StmtClassForgableStmtFields implements StmtClassForgable {
    ...
    public StmtClassForgableType getForgableType() {
        return StmtClassForgableType.FIELDS;
    }
    ...
    public static void makeSubstitutionSetter(CodegenPackageScope packageScope, CodegenMethod method, CodegenClassScope classScope) {
        ...
        CodegenMethod assignMethod = CodegenMethod.makeParentNode(void.class, StmtClassForgableStmtFields.class, classScope).addParam(StatementAIFactoryAssignments.class, "assignments");
        ...
        CodegenMethod setValueMethod = CodegenMethod.makeParentNode(void.class, StmtClassForgableStmtFields.class, classScope).addParam(int.class, "index").addParam(Object.class, "value");
