...
public class DTLocalLocalDateTimeOpsIntervalForge extends DTLocalForgeCalOpsIntervalBase {
    ...
    public DTLocalLocalDateTimeOpsIntervalForge(List<CalendarForge> calendarForges, IntervalForge intervalForge) {
        super(calendarForges, intervalForge);
    }

    public DTLocalEvaluator getDTEvaluator() {
        return new DTLocalLocalDateTimeOpsIntervalEval(getCalendarOps(calendarForges), intervalForge.getOp(), TimeZone.getDefault());
    }
