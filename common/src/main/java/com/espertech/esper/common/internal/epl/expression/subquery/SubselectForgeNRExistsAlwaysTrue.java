...
public class SubselectForgeNRExistsAlwaysTrue implements SubselectForgeNR {

    public final static SubselectForgeNRExistsAlwaysTrue INSTANCE = new SubselectForgeNRExistsAlwaysTrue();
