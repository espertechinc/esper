...
public class DIOPrimitiveFloatArray2DimNullableSerde implements DataInputOutputSerde<float[][]> {
    public final static EPTypeClass EPTYPE = new EPTypeClass(DIOPrimitiveFloatArray2DimNullableSerde.class);

    public final static DIOPrimitiveFloatArray2DimNullableSerde INSTANCE = new DIOPrimitiveFloatArray2DimNullableSerde();
