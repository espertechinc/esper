...
public class DIOBoxedLongArray2DimNullableSerde implements DataInputOutputSerde<Long[][]> {
    public final static EPTypeClass EPTYPE = new EPTypeClass(DIOBoxedLongArray2DimNullableSerde.class);

    public final static DIOBoxedLongArray2DimNullableSerde INSTANCE = new DIOBoxedLongArray2DimNullableSerde();
