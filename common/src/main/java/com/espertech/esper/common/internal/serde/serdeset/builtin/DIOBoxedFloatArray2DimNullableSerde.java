...
public class DIOBoxedFloatArray2DimNullableSerde implements DataInputOutputSerde<Float[][]> {
    public final static EPTypeClass EPTYPE = new EPTypeClass(DIOBoxedFloatArray2DimNullableSerde.class);

    public final static DIOBoxedFloatArray2DimNullableSerde INSTANCE = new DIOBoxedFloatArray2DimNullableSerde();
