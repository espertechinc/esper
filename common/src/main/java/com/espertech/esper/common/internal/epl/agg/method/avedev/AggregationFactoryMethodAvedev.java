...
public class AggregationFactoryMethodAvedev extends AggregationFactoryMethodBase {
    ...
    public AggregationFactoryMethodAvedev(ExprAvedevNode parent, Class aggregatedValueType, ExprNode[] positionalParameters) {
        this.parent = parent;
    ...
    public void initMethodForge(int col, CodegenCtor rowCtor, CodegenMemberCol membersColumnized, CodegenClassScope classScope) {
        ...
        aggregator = new AggregatorAvedev(this, col, rowCtor, membersColumnized, classScope, distinctType, parent.isHasFilter(), parent.getOptionalFilter());
    }
