...
public class JsonDelegateArrayFloat extends JsonDelegateArrayBase {
    public final static EPTypeClass EPTYPE = new EPTypeClass(JsonDelegateArrayFloat.class);
    public JsonDelegateArrayFloat(JsonHandlerDelegator baseHandler, JsonDelegateBase parent) {
