...
/**
 * Functions as a key value for Maps where keys need to be composite values, and includes an {@link EventBean} handle
 ...
 */
public final class HashableMultiKeyEventPair implements Serializable {
    private transient final Object[] keys;
    private transient EventBean eventBean;
    ...
    public final boolean equals(Object other) {
        ...
        if (other instanceof HashableMultiKeyEventPair) {
