...
public class StmtClassForgeableAIFactoryProviderUpdate extends StmtClassForgeableAIFactoryProviderBase {
    private final StatementAgentInstanceFactoryUpdateForge forge;

    public StmtClassForgeableAIFactoryProviderUpdate(String className, CodegenPackageScope packageScope, StatementAgentInstanceFactoryUpdateForge forge) {
        super(className, packageScope);
        this.forge = forge;
    }

    protected EPTypeClass typeOfFactory() {
        return StatementAgentInstanceFactoryUpdate.EPTYPE;
    }
