...
public class DIOBoxedFloatArrayNullableSerde implements DataInputOutputSerde<Float[]> {
    public final static EPTypeClass EPTYPE = new EPTypeClass(DIOBoxedFloatArrayNullableSerde.class);

    public final static DIOBoxedFloatArrayNullableSerde INSTANCE = new DIOBoxedFloatArrayNullableSerde();
