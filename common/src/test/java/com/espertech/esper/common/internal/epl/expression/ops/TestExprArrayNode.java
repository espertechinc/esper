...
public class TestExprArrayNode extends TestCase {
    ...
    public void testToExpressionString() throws Exception {
        assertEquals("{}", ExprNodeUtilityPrint.toExpressionStringMinPrecedenceSafe(arrayNodes[0]));
        assertEquals("{2,3}", ExprNodeUtilityPrint.toExpressionStringMinPrecedenceSafe(arrayNodes[1]));
        assertEquals("{1.5,1}", ExprNodeUtilityPrint.toExpressionStringMinPrecedenceSafe(arrayNodes[2]));
        assertEquals("{\"a\",1}", ExprNodeUtilityPrint.toExpressionStringMinPrecedenceSafe(arrayNodes[3]));
    }
