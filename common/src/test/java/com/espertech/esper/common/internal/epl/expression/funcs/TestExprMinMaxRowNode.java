...
public class TestExprMinMaxRowNode extends TestCase {
    ...
    public void testToExpressionString() throws Exception {
        ...
        assertEquals("max(9.0,6)", ExprNodeUtilityPrint.toExpressionStringMinPrecedenceSafe(minMaxNode));
        minMaxNode.addChildNode(new SupportExprNode(0.5d));
        assertEquals("max(9.0,6,0.5)", ExprNodeUtilityPrint.toExpressionStringMinPrecedenceSafe(minMaxNode));
    }
