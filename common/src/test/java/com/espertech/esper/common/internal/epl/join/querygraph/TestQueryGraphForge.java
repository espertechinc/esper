...
import com.espertech.esper.common.internal.supportunit.util.SupportQueryGraphTestUtil;
...
public class TestQueryGraphForge extends TestCase {
    ...
    public void testFillEquivalency() {
        ...
        assertEquals(0, SupportQueryGraphTestUtil.getStrictKeyProperties(queryGraph, 0, 2).length);
        assertEquals(0, SupportQueryGraphTestUtil.getIndexProperties(queryGraph, 0, 2).length);
        ...
        assertTrue(Arrays.equals(expectedOne, SupportQueryGraphTestUtil.getStrictKeyProperties(queryGraph, 0, 2)));
        assertTrue(Arrays.equals(expectedTwo, SupportQueryGraphTestUtil.getIndexProperties(queryGraph, 0, 2)));
    ...
    public void testGetProperties() {
        ...
        assertTrue(Arrays.equals(expectedTwo, SupportQueryGraphTestUtil.getIndexProperties(queryGraph, 1, 0)));
        assertTrue(Arrays.equals(expectedOne, SupportQueryGraphTestUtil.getIndexProperties(queryGraph, 0, 1)));
        assertTrue(Arrays.equals(expectedOne, SupportQueryGraphTestUtil.getStrictKeyProperties(queryGraph, 1, 0)));
        assertTrue(Arrays.equals(expectedTwo, SupportQueryGraphTestUtil.getStrictKeyProperties(queryGraph, 0, 1)));
    }
    ...
    private final static Logger log = LoggerFactory.getLogger(TestQueryGraphForge.class);
}
