...
public class TestExprEqualsNode extends TestCase {
    ...
    public void testGetType() {
        assertEquals(EPTypePremade.BOOLEANBOXED.getEPType(), equalsNodes[1].getForge().getEvaluationType());
    }
    ...
    public void testToExpressionString() throws Exception {
        ...
        assertEquals("true=false", ExprNodeUtilityPrint.toExpressionStringMinPrecedenceSafe(equalsNodes[0]));
    }
