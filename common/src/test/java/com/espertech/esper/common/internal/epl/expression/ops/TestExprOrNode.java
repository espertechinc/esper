...
public class TestExprOrNode extends TestCase {
    ...
    public void testGetType() {
        assertEquals(EPTypePremade.BOOLEANBOXED.getEPType(), orNode.getForge().getEvaluationType());
    }
    ...
    public void testToExpressionString() throws Exception {
        ...
        orNode.addChildNode(new SupportExprNode(false));
        assertEquals("true or false", ExprNodeUtilityPrint.toExpressionStringMinPrecedenceSafe(orNode));
    }
