...
public class TestJavaClassHelper extends TestCase {
    ...
    public void testGetArrayType() {
        assertEquals(int[].class, getArrayType(int.class));
        assertEquals(Integer[].class, getArrayType(Integer.class));

        assertEquals(Integer.class, getArrayType(Integer.class, 0));
        assertEquals(Integer[].class, getArrayType(Integer.class, 1));
        assertEquals(Integer[][].class, getArrayType(Integer.class, 2));
        assertEquals(Integer[][][].class, getArrayType(Integer.class, 3));
    }
    ...
    public void testImplementsOrExtends() {
        Object[][] tests = new Object[][]{
                ...
                {Map.class, Object.class, true},
                {int.class, Object.class, false},
                ...
                {Object[][].class, Object[][].class, true},
                {Object[][][].class, Object[][].class, true},
                {Number[].class, Object[].class, true},
                {Integer[].class, Object[].class, true},
                {Integer[].class, Number[].class, true},
                {Integer[][].class, Number[].class, false},
                {Integer[][].class, Object[].class, true},
                {int[].class, Object.class, true},
                {Integer[][].class, Object.class, true}
        };
    ...
    public void testGetObjectValuePretty() {
        ...
        assertObjectValuePretty("[10, 20]", new Integer[]{10, 20});
        ...
        assertObjectValuePretty("[10, (null), 20]", new Integer[]{10, null, 20});
        assertObjectValuePretty("[[10, 11], [20, 21]]", new int[][]{{10, 11}, {20, 21}});
    }

    public void testGetArrayDimensions() {
        assertEquals(0, getArrayDimensions(int.class));
        assertEquals(1, getArrayDimensions(int[].class));
        assertEquals(2, getArrayDimensions(int[][].class));
        assertEquals(3, getArrayDimensions(int[][][].class));
        assertEquals(1, getArrayDimensions(Integer[].class));
        assertEquals(1, getArrayDimensions(Object[].class));
    }

    public void testGetArrayComponentTypeInnermost() {
        assertEquals(int.class, getArrayComponentTypeInnermost(int.class));
        assertEquals(int.class, getArrayComponentTypeInnermost(int[].class));
        assertEquals(int.class, getArrayComponentTypeInnermost(int[][].class));
        assertEquals(int.class, getArrayComponentTypeInnermost(int[][][].class));
        assertEquals(Integer.class, getArrayComponentTypeInnermost(Integer[].class));
        assertEquals(Object.class, getArrayComponentTypeInnermost(Object[].class));
    }

    private void assertObjectValuePretty(String expected, Object input) {
        StringWriter writer = new StringWriter();
        JavaClassHelper.getObjectValuePretty(input, writer);
