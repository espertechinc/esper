...
public class TestExprConcatNode extends TestCase {
    ...
    public void testToExpressionString() throws Exception {
        ...
        assertEquals("\"a\"||\"b\"", ExprNodeUtilityPrint.toExpressionStringMinPrecedenceSafe(concatNode));
        concatNode.addChildNode(new SupportExprNode("c"));
        assertEquals("\"a\"||\"b\"||\"c\"", ExprNodeUtilityPrint.toExpressionStringMinPrecedenceSafe(concatNode));
    }
    ...
    private void runAssertionThreading(ThreadingProfile threadingProfile) throws Exception {
        concatNode = new ExprConcatNode();
