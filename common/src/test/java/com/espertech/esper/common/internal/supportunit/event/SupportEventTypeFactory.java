...
public class SupportEventTypeFactory {
    ...
    final static BeanEventType SUPPORTBEAN_S3_EVENTTTPE = makeType(SupportBean_S3.class);
    final static BeanEventType SUPPORTBEAN_S4_EVENTTTPE = makeType(SupportBean_S4.class);
    final static BeanEventType SUPPORTBEAN_A_EVENTTTPE = makeType(SupportBean_A.class);
    final static BeanEventType SUPPORTMARKETDATABEAN_EVENTTTPE = makeType(SupportMarketDataBean.class);
    final static BeanEventType SUPPORTBEANSTRING_EVENTTTPE = makeType(SupportBeanString.class);
    final static BeanEventType SUPPORTBEANCOMPLEXPROPS_EVENTTTPE = makeType(SupportBeanComplexProps.class);
    final static BeanEventType SUPPORTLEGACYBEAN_EVENTTTPE = makeType(SupportLegacyBean.class);
    final static BeanEventType SUPPORTBEANCOMBINEDPROPS_EVENTTTPE = makeType(SupportBeanCombinedProps.class);
    final static BeanEventType SUPPORTBEANPROPERTYNAMES_EVENTTTPE = makeType(SupportBeanPropertyNames.class);
    final static BeanEventType SUPPORTBEANSIMPLE_EVENTTTPE = makeType(SupportBeanSimple.class);
    final static BeanEventType SUPPORTBEANITERABLEPROPS_EVENTTTPE = makeType(SupportBeanIterableProps.class);
    final static BeanEventType SUPPORTABCDEEVENT_EVENTTTPE = makeType(SupportABCDEEvent.class);
    final static BeanEventType SUPPORTBEANITERABLEPROPSCONTAINER_EVENTTYPE = makeType(SupportBeanIterablePropsContainer.class);
    ...
    public static BeanEventType createBeanType(Class clazz) {
        ...
        if (clazz == SupportMarketDataBean.class) {
        ...
        if (clazz == SupportBeanCombinedProps.class) {
        ...
        if (clazz == SupportBean_S3.class) {
            return SUPPORTBEAN_S3_EVENTTTPE;
        }
        if (clazz == SupportBean_S4.class) {
            return SUPPORTBEAN_S4_EVENTTTPE;
        }
        if (clazz == SupportABCDEEvent.class) {
