...
import com.espertech.esper.common.internal.supportunit.bean.SupportMarketDataBean;
...
public class TestStreamTypeServiceImpl extends TestCase {
    ...
    public void setUp() {
        ...
        serviceRegular = new StreamTypeServiceImpl(eventTypes, streamNames, new boolean[10], false, false);
