...
import com.espertech.esper.common.client.util.CountMinSketchAgentStringUTF16;
...
public class TestCountMinSketchStateTopK extends TestCase {
    ...
    public void testFlow() {
        // top-k for 3
        CountMinSketchSpec spec = new CountMinSketchSpec();
        spec.setHashesSpec(TestCountMinSketchStateHashes.getDefaultSpec());
        spec.setTopkSpec(3);
        spec.setAgent(new CountMinSketchAgentStringUTF16());
