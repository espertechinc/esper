...
public class TestExprRegexpNode extends TestCase {
    ...
    public void testToExpressionString() throws Exception {
        assertEquals("s0.theString regexp \"[a-z][a-z]\"", ExprNodeUtilityPrint.toExpressionStringMinPrecedenceSafe(regexpNodeNormal));
        assertEquals("s0.theString not regexp \"[a-z][a-z]\"", ExprNodeUtilityPrint.toExpressionStringMinPrecedenceSafe(regexpNodeNot));
    }
