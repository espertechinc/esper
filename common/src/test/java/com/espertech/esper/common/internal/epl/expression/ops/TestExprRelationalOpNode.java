...
public class TestExprRelationalOpNode extends TestCase {
    ...
    public void testGetType() throws Exception {
        ...
        assertEquals(EPTypePremade.BOOLEANBOXED.getEPType(), opNode.getForge().getEvaluationType());
    }
    ...
    public void testToExpressionString() throws Exception {
        ...
        assertEquals("10>=5", ExprNodeUtilityPrint.toExpressionStringMinPrecedenceSafe(opNode));
    }
