...
import com.espertech.esper.common.internal.supportunit.util.SupportStreamTypeSvc3Stream;
...
public class TestExprIdentNode extends TestCase {
    ...
    public void testToExpressionString() throws Exception {
        ...
        assertEquals("mapped('a')", ExprNodeUtilityPrint.toExpressionStringMinPrecedenceSafe(identNodes[0]));
        assertEquals("nested.nestedValue", ExprNodeUtilityPrint.toExpressionStringMinPrecedenceSafe(identNodes[1]));
        assertEquals("s2.indexed[1]", ExprNodeUtilityPrint.toExpressionStringMinPrecedenceSafe(identNodes[2]));
        assertEquals("s0.intPrimitive", ExprNodeUtilityPrint.toExpressionStringMinPrecedenceSafe(identNodes[3]));
    }
