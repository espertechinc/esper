...
public class Simulator implements Runnable {
    ...
    public Simulator(EPEventService runtime, SimPlayerStrategy[] playerStrategies, int numQuestions) {
        ...
        for (int i = 0; i < numQuestions; i++) {
            ...
            for (int sec = 0; sec < 30; sec++) {
                ...
                if (!sleep) {
                    ...
                    runtime.advanceTime(currentTime);
                } else {
                    Thread.sleep(1000);
                }
            ...
            runtime.sendEventMap(EventFactory.makeUpdateScore((String) currentQuestion.get("questionId")), "UpdateScore");
        }
