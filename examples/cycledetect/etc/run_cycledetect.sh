...
# Script to run quality of service example
#
...
$JAVA_HOME/bin/java $MEMORY_OPTIONS -Dlog4j.configuration=log4j.xml -cp ${CLASSPATH} com.espertech.esper.example.qos_sla.QualityOfServiceMain $1 $2
