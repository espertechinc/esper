...
set CLASSPATH=%CLASSPATH%;..\..\..\esper-common-8.0.0-beta3.jar
set CLASSPATH=%CLASSPATH%;..\..\..\esper-compiler-8.0.0-beta3.jar
set CLASSPATH=%CLASSPATH%;..\..\..\esper-runtime-8.0.0-beta3.jar
