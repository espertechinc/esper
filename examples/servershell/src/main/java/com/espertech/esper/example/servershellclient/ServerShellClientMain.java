...
import com.espertech.esper.example.servershell.jmx.EPRuntimeJMXMBean;
...
public class ServerShellClientMain {
    ...
    public ServerShellClientMain() throws Exception {
        ...
        EPRuntimeJMXMBean proxy = (EPRuntimeJMXMBean) MBeanServerInvocationHandler.newProxyInstance(
            mbsc, mBeanName, EPRuntimeJMXMBean.class, true);
