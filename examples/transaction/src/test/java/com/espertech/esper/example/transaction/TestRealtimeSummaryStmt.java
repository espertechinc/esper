...
public class TestRealtimeSummaryStmt extends TestStmtBase {
    ...
    public void setUp() {
        ...
        RealtimeSummaryStmt realtimeStmt = new RealtimeSummaryStmt(runtime);
    ...
    public void testFlow() {
        runtime.getEventService().advanceTime(1000); // Set the time to 1 seconds
        ...
        runtime.getEventService().advanceTime(10000); // Set the time to 10 seconds
        ...
        runtime.getEventService().advanceTime(20000); // Set the time to 20 seconds
