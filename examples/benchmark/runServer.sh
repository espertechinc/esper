...
CP="etc:bin:$LCP:lib/esper-6.0.0.jar:lib/esper_examples_benchmark-6.0.0.jar:lib/commons-logging-1.1.3.jar:lib/cglib-nodep-3.1.jar:lib/antlr-runtime-4.1.jar:lib/log4j-1.2.17.jar"
