...
LCP=../../esper/target/classes:target/classes:../../esper/lib/slf4j-reload4j-1.7.36.jar:../../esper/lib/slf4j-api-1.7.36.jar:../../esper/lib/antlr4-runtime-4.13.1.jar:../../esper/lib/reload4j-1.2.25.jar
CP="etc:bin:$LCP:lib/esper-common-9.0.0.jar:lib/esper-compiler-9.0.0.jar:lib/esper-runtime-9.0.0.jar:lib/esper_examples_benchmark-9.0.0.jar:lib/slf4j-reload4j-1.7.36.jar:lib/slf4j-api-1.7.36.jar:lib/antlr4-runtime-4.13.1.jar:lib/reload4j-1.2.25.jar"
