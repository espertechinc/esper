...
LCP=../../esper/target/classes:target/classes:../../esper/lib/commons-logging-1.1.3.jar:../../esper/lib/cglib-nodep-3.1.jar:../../esper/lib/antlr-runtime-4.1.jar:../../esper/lib/log4j-1.2.17.jar
CP="etc:bin:$LCP:lib/esper-5.4.0.jar:lib/esper_examples_benchmark-5.4.0.jar:lib/commons-logging-1.1.3.jar:lib/cglib-nodep-3.1.jar:lib/antlr-runtime-4.1.jar:lib/log4j-1.2.17.jar"
