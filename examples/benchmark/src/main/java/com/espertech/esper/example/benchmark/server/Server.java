 ...
 * It bootstrap an ESP/CEP runtime (defaults to Esper) and registers EPL statement(s) into it based
 ...
 * <p/>
 * Based on -queue, the server implements a direct handoff to the ESP/CEP runtime, or uses a Syncrhonous queue
