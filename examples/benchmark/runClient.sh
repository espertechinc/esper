...
CP="etc:bin:$LCP:lib/esper-common-8.9.0.jar:lib/esper-compiler-8.9.0.jar:lib/esper-runtime-8.9.0.jar:lib/esper_examples_benchmark-8.9.0.jar:lib/slf4j-api-1.7.36.jar:lib/slf4j-reload4j-1.7.36.jar:lib/antlr4-runtime-4.9.3.jar:lib/reload4j-1.2.19.jar"
