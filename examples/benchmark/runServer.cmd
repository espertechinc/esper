...
set CP=etc;bin;%LCP%;lib\esper-7.0.0.jar;lib\esper_examples_benchmark-7.0.0.jar;lib\slf4j-api-1.7.21.jar;lib\slf4j-log4j12-1.7.21.jar;lib\cglib-nodep-3.2.4.jar;lib\antlr-runtime-4.5.3.jar;lib\log4j-1.2.17.jar
