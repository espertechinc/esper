...
public class TestIndexTreeBuilderMultithreaded extends TestCase {
    ...
    public void setUp() {
        ...
        testFilterSpecs = new Vector<FilterSpecActivatable>();
    ...
    public void testVerifyFilterSpecSet() {
        ...
        for (FilterSpecActivatable filterSpec : testFilterSpecs) {
    ...
    private void performMultithreadedTest(FilterHandleSetNode topNode,
        ...
        for (int i = 0; i < numberOfRunnables; i++) {
            SupportIndexTreeBuilderRunnable runnable = new SupportIndexTreeBuilderRunnable(eventType, topNode,
