 ...
 * *************************************************************************************
 */
package com.espertech.esper.runtime.internal.metrics.codahale_metrics.metrics.reporting;

import com.espertech.esper.runtime.internal.metrics.codahale_metrics.metrics.core.*;
...
public class JmxReporter extends AbstractReporter implements MetricsRegistryListener,
    ...
    private static class Gauge extends AbstractBean implements GaugeMBean {
        private final com.espertech.esper.runtime.internal.metrics.codahale_metrics.metrics.core.Gauge<?> metric;

        private Gauge(com.espertech.esper.runtime.internal.metrics.codahale_metrics.metrics.core.Gauge<?> metric, ObjectName objectName) {
            super(objectName);
            this.metric = metric;
        }
    ...
    private static class Counter extends AbstractBean implements CounterMBean {
        private final com.espertech.esper.runtime.internal.metrics.codahale_metrics.metrics.core.Counter metric;

        private Counter(com.espertech.esper.runtime.internal.metrics.codahale_metrics.metrics.core.Counter metric, ObjectName objectName) {
            super(objectName);
            this.metric = metric;
        }
    ...
    private static class Histogram implements HistogramMBean {
        private final ObjectName objectName;
        private final com.espertech.esper.runtime.internal.metrics.codahale_metrics.metrics.core.Histogram metric;

        private Histogram(com.espertech.esper.runtime.internal.metrics.codahale_metrics.metrics.core.Histogram metric, ObjectName objectName) {
            this.metric = metric;
            this.objectName = objectName;
        }
    ...
    static class TimerImpl extends Meter implements TimerMBean {
        private final Timer metric;

        private TimerImpl(Timer metric, ObjectName objectName) {
    ...
    @Override
    public void processCounter(MetricName name, com.espertech.esper.runtime.internal.metrics.codahale_metrics.metrics.core.Counter counter, Context context) throws Exception {
    ...
    @Override
    public void processHistogram(MetricName name, com.espertech.esper.runtime.internal.metrics.codahale_metrics.metrics.core.Histogram histogram, Context context) throws Exception {
        registerBean(context.getMetricName(),
    ...
    @Override
    public void processGauge(MetricName name, com.espertech.esper.runtime.internal.metrics.codahale_metrics.metrics.core.Gauge gauge, Context context) throws Exception {
