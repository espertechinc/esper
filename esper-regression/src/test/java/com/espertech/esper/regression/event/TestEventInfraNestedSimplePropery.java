...
public class TestEventInfraNestedSimplePropery extends TestCase  {
    ...
    private void runAssertion(String typename, FunctionSendEvent4Int send) {
        ...
        EPAssertionUtil.assertProps(listener.assertOneGetNewAndReset(), fields, new Object[] {1, true, 2, true, 3, true, 4, true});
    ...
    private void addMapEventType() {
        Map<String, Object> lvl4 = Collections.singletonMap("lvl4", int.class);
        Map<String, Object> lvl3 = twoEntryMap("l4", lvl4, "lvl3", int.class);
        Map<String, Object> lvl2 = twoEntryMap("l3", lvl3, "lvl2", int.class);
        Map<String, Object> lvl1 = twoEntryMap("l2", lvl2, "lvl1", int.class);
        Map<String, Object> top = Collections.singletonMap("l1", lvl1);
