...
public class ExecEventInfraPropertyNestedSimple implements RegressionExecution {
    ...
    public void run(EPServiceProvider epService) {
        ...
        runAssertion(epService, BEAN_TYPENAME, FBEAN, InfraNestedSimplePropLvl1.class, InfraNestedSimplePropLvl1.class.getTypeName());
        ...
        runAssertion(epService, AVRO_TYPENAME, FAVRO, GenericData.Record.class, "MyAvroEvent_1");
    }
    ...
    public final static class InfraNestedSimplePropTop {
