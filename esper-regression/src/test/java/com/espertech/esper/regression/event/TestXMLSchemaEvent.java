...
public class TestXMLSchemaEvent extends TestCase
{
    ...
    public void testSchemaXMLWSchemaWithRestriction() throws Exception
    {
        ...
        InputStream schemaStream = TestXMLSchemaEvent.class.getClassLoader().getResourceAsStream(CLASSLOADER_SCHEMA_WITH_RESTRICTION_URI);
    ...
    public void testSchemaXMLWSchemaWithAll() throws Exception
    {
        ...
        String schemaUri = TestXMLSchemaEvent.class.getClassLoader().getResource(CLASSLOADER_SCHEMA_WITH_ALL_URI).toString();
