...
public class TestInsertIntoTransposeStream extends TestCase
{
    ...
    public void testInvalidTranspose()
    {
        ...
        {
            assertEquals("Error starting statement: Failed to validate select-clause expression 'inneritem.nestedValue': Failed to resolve property 'inneritem.nestedValue' (property 'inneritem' is a mapped property and requires keyed access) [select inneritem.nestedValue as result from MyStream]", ex.getMessage());
        }
