...
public class ExecPatternOperatorFollowedByMax2Prevent implements RegressionExecution, SupportBeanConstants {
    ...
    public void run(EPServiceProvider epService) throws Exception {
        if (SupportConfigFactory.skipTest(ExecPatternOperatorFollowedByMax2Prevent.class)) {
            return;
        }
