...
public class TestVirtualDataWindow extends TestCase implements IndexBackingTableInfo {
    ...
    public void testSubquery() {
        ...
        SupportVirtualDW thewindow = (SupportVirtualDW) getFromContext("/virtualdw/MySampleWindow");
        Map<String, Object> row1 = Collections.<String, Object>singletonMap("id", "V1");
