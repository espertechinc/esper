...
public class TestTableMTUngroupedSubqueryReadMergeWriteColumnUpd extends TestCase
{
    private static final Logger log = LoggerFactory.getLogger(TestTableMTUngroupedSubqueryReadMergeWriteColumnUpd.class);
    ...
    private void tryMT(int numSeconds) throws Exception
    {
        ...
        TestTableMTUngroupedJoinColumnConsistency.Update_1_2_WriteRunnable writeRunnable = new TestTableMTUngroupedJoinColumnConsistency.Update_1_2_WriteRunnable(epService);
