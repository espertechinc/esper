...
public class TestXMLSchemaEventReplace extends TestCase
{
    ...
    {
        if (SupportConfigFactory.skipTest(TestXMLSchemaEventReplace.class)) {
            return;
        }

        ConfigurationEventTypeXMLDOM eventTypeMeta = new ConfigurationEventTypeXMLDOM();
        eventTypeMeta.setRootElementName("simpleEvent");
        String schemaUri = TestXMLSchemaEventReplace.class.getClassLoader().getResource(CLASSLOADER_SCHEMA_URI).toString();
        ...
        schemaUri = TestXMLSchemaEventReplace.class.getClassLoader().getResource(CLASSLOADER_SCHEMA_VERSION2_URI).toString();
        eventTypeMeta.setSchemaResource(schemaUri);
