...
public class TestXMLSchemaEventForObservation extends TestCase
{
    ...
    public void testObservationExamplePropertyExpression() throws Exception
    {
        ...
        String schemaUri = TestXMLSchemaEventForObservation.class.getClassLoader().getResource(CLASSLOADER_SCHEMA_URI).toString();
