...
public class ExecOuterJoin6Stream implements RegressionExecution {
    ...
    private void runAssertionRoot_s3(EPServiceProvider epService) {
        ...
        EPStatement stmt = epService.getEPAdministrator().createEPL(rpl);
        SupportUpdateListener listener = new SupportUpdateListener();
        stmt.addListener(listener);
    ...
    private void tryAssertion(EPServiceProvider epService, SupportUpdateListener listener) {
        ...
        EPAssertionUtil.assertSameAnyOrder(new Object[][]{
                {null, s1Events[0], null, s3Events[0], null, null}}, getAndResetNewEvents(listener));
        ...
        EPAssertionUtil.assertSameAnyOrder(new Object[][]{
                {null, null, null, null, s4Events[0], null}}, getAndResetNewEvents(listener));
        ...
        EPAssertionUtil.assertSameAnyOrder(new Object[][]{
                {null, null, s2Events[0], null, s4Events[0], s5Events[0]}}, getAndResetNewEvents(listener));

        s0Events = SupportBean_S0.makeS0("F", new String[]{"F-s0-1"});
        sendEvent(epService, s0Events);
        EPAssertionUtil.assertSameAnyOrder(new Object[][]{
                {s0Events[0], s1Events[0], s2Events[0], s3Events[0], s4Events[0], s5Events[0]}}, getAndResetNewEvents(listener));
        ...
        EPAssertionUtil.assertSameAnyOrder(new Object[][]{
                ...
                {s0Events[0], s1Events[1], s2Events[1], s3Events[0], s4Events[0], s5Events[1]}}, getAndResetNewEvents(listener));
        ...
        EPAssertionUtil.assertSameAnyOrder(new Object[][]{
                ...
                {s0Events[0], s1Events[1], s2Events[1], s3Events[1], s4Events[1], s5Events[1]}}, getAndResetNewEvents(listener));
        ...
        EPAssertionUtil.assertSameAnyOrder(new Object[][]{
                ...
                {s0Events[0], s1Events[1], s2Events[0], s3Events[0], s4Events[0], s5Events[0]},
                {s0Events[0], s1Events[0], s2Events[0], s3Events[0], s4Events[1], s5Events[0]},
                {s0Events[0], s1Events[1], s2Events[0], s3Events[0], s4Events[2], s5Events[0]}}, getAndResetNewEvents(listener));
        ...
        EPAssertionUtil.assertSameAnyOrder(new Object[][]{
                {s0Events[0], s1Events[0], s2Events[0], s3Events[0], s4Events[0], s5Events[0]},
                {s0Events[0], s1Events[0], s2Events[0], s3Events[0], s4Events[1], s5Events[0]}}, getAndResetNewEvents(listener));
        ...
        EPAssertionUtil.assertSameAnyOrder(new Object[][]{
                ...
                {null, null, s2Events[0], null, s4Events[0], s5Events[1]}}, getAndResetNewEvents(listener));
        ...
        EPAssertionUtil.assertSameAnyOrder(new Object[][]{
                ...
                {s0Events[0], s1Events[0], s2Events[0], s3Events[0], s4Events[0], s5Events[1]},
                {s0Events[0], s1Events[0], s2Events[0], s3Events[1], s4Events[0], s5Events[1]},
                {s0Events[0], s1Events[0], s2Events[0], s3Events[2], s4Events[0], s5Events[1]}}, getAndResetNewEvents(listener));
        ...
        sendEvent(epService, s3Events);
        EPAssertionUtil.assertSameAnyOrder(new Object[][]{
                {null, null, null, s3Events[0], null, null}}, getAndResetNewEvents(listener));
        ...
        EPAssertionUtil.assertSameAnyOrder(new Object[][]{
                ...
                {null, s1Events[1], null, s3Events[0], null, null}}, getAndResetNewEvents(listener));
        ...
        EPAssertionUtil.assertSameAnyOrder(new Object[][]{
                ...
                {s0Events[0], s1Events[1], s2Events[1], s3Events[0], s4Events[1], s5Events[1]},
                {s0Events[1], s1Events[1], s2Events[1], s3Events[0], s4Events[1], s5Events[1]}}, getAndResetNewEvents(listener));
        ...
        EPAssertionUtil.assertSameAnyOrder(new Object[][]{
                {s0Events[0], s1Events[0], s2Events[0], s3Events[0], s4Events[0], s5Events[0]},
                {s0Events[0], s1Events[0], s2Events[0], s3Events[0], s4Events[0], s5Events[1]}}, getAndResetNewEvents(listener));
        ...
        EPAssertionUtil.assertSameAnyOrder(new Object[][]{
                ...
                {s0Events[0], s1Events[0], s2Events[1], s3Events[0], s4Events[0], s5Events[0]},
                {s0Events[0], s1Events[1], s2Events[0], s3Events[0], s4Events[0], s5Events[0]},
                {s0Events[0], s1Events[1], s2Events[1], s3Events[0], s4Events[0], s5Events[0]}}, getAndResetNewEvents(listener));
        ...
        EPAssertionUtil.assertSameAnyOrder(new Object[][]{
                {s0Events[0], s1Events[0], s2Events[0], s3Events[0], s4Events[0], s5Events[0]},
                {s0Events[1], s1Events[0], s2Events[0], s3Events[0], s4Events[0], s5Events[0]}}, getAndResetNewEvents(listener));
        ...
        EPAssertionUtil.assertSameAnyOrder(new Object[][]{
                ...
                {s0Events[0], s1Events[0], s2Events[0], s3Events[0], s4Events[1], s5Events[0]},
                {s0Events[0], s1Events[0], s2Events[0], s3Events[1], s4Events[0], s5Events[0]},
                {s0Events[0], s1Events[0], s2Events[0], s3Events[1], s4Events[1], s5Events[0]}}, getAndResetNewEvents(listener));
