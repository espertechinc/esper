...
public class TestXMLNoSchemaEventTranspose extends TestCase
{
    ...
    public void testExpressionSimpleXPathGetter() throws Exception
    {
        ConfigurationEventTypeXMLDOM eventTypeMeta = new ConfigurationEventTypeXMLDOM();
        eventTypeMeta.setRootElementName("simpleEvent");
        String schemaUri = TestXMLNoSchemaEventTranspose.class.getClassLoader().getResource(CLASSLOADER_SCHEMA_URI).toString();
