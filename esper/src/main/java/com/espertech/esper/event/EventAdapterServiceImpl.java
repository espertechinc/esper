...
public class EventAdapterServiceImpl implements EventAdapterService
{
    ...
    {
        Pair<EventType[], Set<EventType>> mapSuperTypes = getSuperTypesDepthFirst(optionalConfig != null ? optionalConfig.getSuperTypes() : null, EventUnderlyingType.MAP);
    ...
    public synchronized EventType addNestableObjectArrayType(String eventTypeName, Map<String, Object> propertyTypes, ConfigurationEventTypeObjectArray optionalConfig, boolean isPreconfiguredStatic, boolean isPreconfigured, boolean isConfigured, boolean namedWindow, boolean insertInto, boolean table, String tableName) throws EventAdapterException
    {
        ...
        Pair<EventType[], Set<EventType>> mapSuperTypes = getSuperTypesDepthFirst(optionalConfig != null ? optionalConfig.getSuperTypes() : null, EventUnderlyingType.OBJECTARRAY);
    ...
    private Pair<EventType[], Set<EventType>> getSuperTypesDepthFirst(Set<String> superTypesSet, EventUnderlyingType representation)
    ...
    public EventType addAvroType(String eventTypeName, ConfigurationEventTypeAvro avro, boolean isPreconfiguredStatic, boolean isPreconfigured, boolean isConfigured, boolean isNamedWindow, boolean isInsertInto) throws EventAdapterException {
        ...
        int typeId = eventTypeIdGenerator.getTypeId(eventTypeName);
        Pair<EventType[], Set<EventType>> avroSuperTypes = getSuperTypesDepthFirst(avro != null ? avro.getSuperTypes() : null, EventUnderlyingType.AVRO);
