 ...
 * </p>
 */
public class QuadTree<L> {
    private final int leafCapacity;
    private final int maxTreeHeight;
    private QuadTreeNode<L> root;

    public QuadTree(int leafCapacity, int maxTreeHeight, QuadTreeNode<L> root) {
    ...
    public QuadTreeNode<L> getRoot() {
        return root;
    }

    public void setRoot(QuadTreeNode<L> root) {
        this.root = root;
    }

    public void clear() {
        root = new QuadTreeNodeLeaf<>(root.getBb(), root.getLevel(), null, 0);
    }
}
