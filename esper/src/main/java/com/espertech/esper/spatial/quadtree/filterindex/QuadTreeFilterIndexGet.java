...
public class QuadTreeFilterIndexGet {
    public static <L> L get(double x, double y, QuadTree<Object> tree) {
        checkBB(tree.getRoot().getBb(), x, y);
        return get(x, y, tree.getRoot());
    }

    private static <L> L get(double x, double y, QuadTreeNode<Object> node) {
