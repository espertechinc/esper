...
public class ExprDotNodeFilterAnalyzerDescIndexProvision implements ExprDotNodeFilterAnalyzerDesc {
    ...
    public ExprDotNodeFilterAnalyzerDescIndexProvision(String operationName, ExprNode[] indexExpressions, List<Pair<ExprNode, int[]>> keyExpressions, int streamNumIndex) {
