...
public class ExprTableEvalStrategyGroupByTopLevelMulti extends ExprTableEvalStrategyGroupByTopLevelBase {
    ...
    public ExprTableEvalStrategyGroupByTopLevelMulti(Lock lock, TableStateInstanceGrouped grouped, Map<String, TableMetadataColumn> items, ExprEvaluator[] groupExpr) {
