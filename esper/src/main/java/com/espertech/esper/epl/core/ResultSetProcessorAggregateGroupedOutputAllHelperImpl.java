...
public class ResultSetProcessorAggregateGroupedOutputAllHelperImpl implements ResultSetProcessorAggregateGroupedOutputAllHelper {
    ...
    public void processView(EventBean[] newData, EventBean[] oldData, boolean isGenerateSynthetic) {
        ...
        if (processor.prototype.isSelectRStream()) {
            processor.generateOutputBatchedView(oldData, oldDataMultiKey, false, isGenerateSynthetic, eventsOld, null);
        }
        processor.generateOutputBatchedView(newData, newDataMultiKey, true, isGenerateSynthetic, eventsNew, null);
    ...
    public void processJoin(Set<MultiKey<EventBean>> newData, Set<MultiKey<EventBean>> oldData, boolean isGenerateSynthetic) {
        ...
        if (processor.prototype.isSelectRStream()) {
            processor.generateOutputBatchedJoin(oldData, oldDataMultiKey, false, isGenerateSynthetic, eventsOld, null);
        }
        processor.generateOutputBatchedJoin(newData, newDataMultiKey, false, isGenerateSynthetic, eventsNew, null);
