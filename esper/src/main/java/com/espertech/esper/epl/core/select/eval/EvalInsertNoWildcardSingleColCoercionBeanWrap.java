...
public class EvalInsertNoWildcardSingleColCoercionBeanWrap extends EvalBaseFirstPropFromWrap implements SelectExprProcessor {
    ...
    public EvalInsertNoWildcardSingleColCoercionBeanWrap(SelectExprForgeContext selectExprForgeContext, WrapperEventType wrapper) {
    ...
    protected CodegenExpression processFirstColCodegen(Class evaluationType, CodegenExpression expression, CodegenMember memberResultEventType, CodegenMember memberEventAdapterService, CodegenMethodScope codegenMethodScope, CodegenClassScope codegenClassScope) {
        return EvalInsertNoWildcardSingleColCoercionMapWrap.processFirstColCodegen(expression, memberEventAdapterService, codegenClassScope, wrapper, "adapterForTypedBean", Object.class);
    }
}
