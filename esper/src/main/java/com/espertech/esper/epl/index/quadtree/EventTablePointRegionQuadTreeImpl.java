...
import static com.espertech.esper.epl.index.quadtree.AdvancedIndexPointRegionQuadTree.COL_X;
import static com.espertech.esper.epl.index.quadtree.AdvancedIndexPointRegionQuadTree.COL_Y;
...
public class EventTablePointRegionQuadTreeImpl implements EventTablePointRegionQuadTree {

    private final EventTableOrganization organization;
    private final EventBean[] eventsPerStream = new EventBean[1];
    private final AdvancedIndexConfigStatementQuadtree config;
    private final QuadTree<Object> quadTree;

    public EventTablePointRegionQuadTreeImpl(EventTableOrganization organization, AdvancedIndexConfigStatementQuadtree config, QuadTree<Object> quadTree) {
