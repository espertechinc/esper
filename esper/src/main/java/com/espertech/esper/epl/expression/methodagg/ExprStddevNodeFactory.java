...
{
    private final ExprStddevNode parent;
    private final Class aggregatedValueType;

    public ExprStddevNodeFactory(ExprStddevNode parent, Class aggregatedValueType) {
        this.parent = parent;
    ...
    public AggregationMethod make(MethodResolutionService methodResolutionService, int agentInstanceId, int groupId, int aggregationId) {
        AggregationMethod method = methodResolutionService.makeStddevAggregator(agentInstanceId, groupId, aggregationId, parent.isHasFilter());
