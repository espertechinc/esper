...
public interface ResultSetProcessorHelperFactory {
    ...
    ResultSetProcessorSimpleOutputAllHelper makeRSSimpleOutputAll(ResultSetProcessorSimpleFactory prototype, ResultSetProcessorSimple resultSetProcessorSimple, AgentInstanceContext agentInstanceContext, int numStreams);
    ...
    ResultSetProcessorRowPerGroupOutputAllGroupReps makeRSRowPerGroupOutputAllNoOpt(AgentInstanceContext agentInstanceContext, ResultSetProcessorRowPerGroupFactory prototype);
