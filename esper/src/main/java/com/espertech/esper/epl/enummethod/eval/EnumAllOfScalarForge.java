...
public class EnumAllOfScalarForge extends EnumForgeBaseScalar {
    ...
    public EnumEval getEnumEvaluator() {
        return new EnumAllOfScalarForgeEval(this, innerExpression.getExprEvaluator());
    }

    public CodegenExpression codegen(CodegenParamSetEnumMethodNonPremade premade, CodegenContext context) {
        return EnumAllOfScalarForgeEval.codegen(this, premade, context);
    }
}
