...
{
    private final ExprSumNode parent;
    private final Class resultType;
    private final Class inputValueType;

    public ExprSumNodeFactory(ExprSumNode parent, MethodResolutionService methodResolutionService, Class inputValueType)
    {
        this.parent = parent;
    ...
    public AggregationMethod make(MethodResolutionService methodResolutionService, int agentInstanceId, int groupId, int aggregationId) {
        AggregationMethod method = methodResolutionService.makeSumAggregator(agentInstanceId, groupId, aggregationId, inputValueType, parent.isHasFilter());
        if (!parent.isDistinct()) {
            return method;
        }
        return methodResolutionService.makeDistinctAggregator(agentInstanceId, groupId, aggregationId, method, inputValueType, parent.isHasFilter());
    }
    ...
    public void validateIntoTableCompatible(AggregationMethodFactory intoTableAgg) throws ExprValidationException {
        ...
        AggregationMethodFactoryUtil.validateAggregationInputType(inputValueType, that.inputValueType);
