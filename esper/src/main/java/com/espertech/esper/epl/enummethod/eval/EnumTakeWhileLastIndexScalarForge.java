...
public class EnumTakeWhileLastIndexScalarForge extends EnumForgeBaseScalarIndex {
    ...
    public EnumEval getEnumEvaluator() {
        return new EnumTakeWhileLastIndexScalarForgeEval(this, innerExpression.getExprEvaluator());
    }

    public CodegenExpression codegen(CodegenParamSetEnumMethodNonPremade premade, CodegenContext context) {
        return EnumTakeWhileLastIndexScalarForgeEval.codegen(this, premade, context);
    }
}
