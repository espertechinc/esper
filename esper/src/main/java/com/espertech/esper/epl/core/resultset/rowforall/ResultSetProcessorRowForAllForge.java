...
public class ResultSetProcessorRowForAllForge implements ResultSetProcessorFactoryForge {
    ...
    public void instanceCodegen(ResultSetProcessorCodegenInstance instance, CodegenClassScope classScope) {
        instance.addMethod(AggregationService.class, "getAggregationService", Collections.emptyList(), ResultSetProcessorRowForAll.class, classScope, methodNode -> methodNode.getBlock().methodReturn(REF_AGGREGATIONSVC));
        instance.addMethod(ExprEvaluatorContext.class, "getExprEvaluatorContext", Collections.emptyList(), ResultSetProcessorRowForAll.class, classScope, methodNode -> methodNode.getBlock().methodReturn(REF_AGENTINSTANCECONTEXT));
