...
public class EvalInsertNoWildcardSingleColCoercionBeanWrap extends EvalBaseFirstPropFromWrap implements SelectExprProcessor {
    ...
    protected CodegenExpression processFirstColCodegen(Class evaluationType, CodegenExpression expression, CodegenMember memberResultEventType, CodegenMember memberEventAdapterService, CodegenContext context) {
        return EvalInsertNoWildcardSingleColCoercionMapWrap.processFirstColCodegen(expression, memberEventAdapterService, context, wrapper, "adapterForTypedBean", Object.class);
    }
}
