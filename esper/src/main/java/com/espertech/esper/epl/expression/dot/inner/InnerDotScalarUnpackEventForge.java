...
public class InnerDotScalarUnpackEventForge implements ExprDotEvalRootChildInnerForge {
    ...
    public ExprDotEvalRootChildInnerEval getInnerEvaluator() {
        return new InnerDotScalarUnpackEventEval(rootForge.getExprEvaluator());
    }

    public CodegenExpression codegenEvaluate(CodegenParamSetExprPremade params, CodegenContext context) {
        return InnerDotScalarUnpackEventEval.codegenEvaluate(this, context, params);
    }
