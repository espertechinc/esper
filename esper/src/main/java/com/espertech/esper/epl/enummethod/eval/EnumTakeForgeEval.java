...
public class EnumTakeForgeEval implements EnumEval {
    ...
    public static CodegenExpression codegen(EnumTakeForge forge, CodegenParamSetEnumMethodNonPremade args, CodegenContext context) {
        ...
        String method = block.methodReturn(staticMethod(EnumTakeForgeEval.class, "evaluateEnumTakeMethod", premade.enumcoll(), SimpleNumberCoercerFactory.SimpleNumberCoercerInt.codegenInt(ref("size"), sizeType)));
