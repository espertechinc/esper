 ...
 */
public class SubselectEvalStrategyNREqualsAnyDefault extends SubselectEvalStrategyNREqualsBase {
    private final ExprEvaluator filterEval;

    public SubselectEvalStrategyNREqualsAnyDefault(ExprEvaluator valueEval, ExprEvaluator selectEval, boolean resultWhenNoMatchingEvents, boolean notIn, SimpleNumberCoercer coercer, ExprEvaluator filterEval) {
