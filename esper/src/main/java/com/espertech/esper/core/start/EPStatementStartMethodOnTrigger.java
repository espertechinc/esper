...
public class EPStatementStartMethodOnTrigger extends EPStatementStartMethodBase
{
            ...
            throws ExprValidationException
    {
        ...
        ViewableActivatorNamedWindow activator = new ViewableActivatorNamedWindow(processor, namedSpec.getFilterExpressions(), namedSpec.getOptPropertyEvaluator());
            ...
            throws ExprValidationException
    {
        ...
        OutputProcessViewFactory outputViewFactory = OutputProcessViewFactoryFactory.make(statementSpec, services.getInternalEventRouter(), statementContext, null, null, services.getTableService());
            ...
            throws ExprValidationException
    {
        ...
        OutputProcessViewFactory outputViewFactory = OutputProcessViewFactoryFactory.make(statementSpec, services.getInternalEventRouter(), statementContext, resultEventType, null, services.getTableService());
