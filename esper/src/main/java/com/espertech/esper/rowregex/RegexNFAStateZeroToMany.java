...
public class RegexNFAStateZeroToMany extends RegexNFAStateBase implements RegexNFAState {
     ...
     */
    public RegexNFAStateZeroToMany(String nodeNum, String variableName, int streamNum, boolean multiple, boolean isGreedy, ExprEvaluator exprEvaluator, boolean exprRequiresMultimatchState) {
