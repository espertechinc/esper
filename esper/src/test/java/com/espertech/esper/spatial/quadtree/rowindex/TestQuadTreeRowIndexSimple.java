...
import static com.espertech.esper.spatial.quadtree.rowindex.SupportQuadTreeRowIndexUtil.assertFound;

public class TestQuadTreeRowIndexSimple extends TestCase {
    ...
    public void testAddRemoveSimple() {
        tree = QuadTreeFactory.make(0, 0, 50, 60, 4, 20);
        ...
        SupportQuadTreeRowIndexUtil.remove(tree, 5, 8, "P1");
        assertFound(tree, 0, 0, 10, 10, "");
    }
    ...
    public void testAddRemoveSamePoint() {
        ...
        SupportQuadTreeRowIndexUtil.remove(tree, 5, 8, "P2");
        assertFound(tree, 0, 0, 10, 10, "");
    }
