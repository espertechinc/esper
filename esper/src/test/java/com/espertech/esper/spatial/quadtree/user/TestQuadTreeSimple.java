...
import static com.espertech.esper.spatial.quadtree.user.SupportQuadTreeUtil.assertFound;

public class TestQuadTreeSimple extends TestCase {
    ...
    public void testAddRemoveSimple() {
        ...
        SupportQuadTreeUtil.remove(tree, 5, 8, "P1");
        assertFound(tree, 0, 0, 10, 10, "");
    }
    ...
    public void testAddRemoveSamePoint() {
        ...
        SupportQuadTreeUtil.remove(tree, 5, 8, "P2");
        assertFound(tree, 0, 0, 10, 10, "");
    }
