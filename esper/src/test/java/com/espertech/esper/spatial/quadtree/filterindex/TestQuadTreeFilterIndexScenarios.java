...
import com.espertech.esper.spatial.quadtree.rowindex.XYPointMultiType;
import junit.framework.TestCase;

import java.util.Collection;
import java.util.List;

import static com.espertech.esper.spatial.quadtree.core.SupportQuadTreeUtil.navigateBranch;
import static com.espertech.esper.spatial.quadtree.core.SupportQuadTreeUtil.navigateLeaf;
import static com.espertech.esper.spatial.quadtree.filterindex.SupportQuadTreeFilterIndexUtil.*;

public class TestQuadTreeFilterIndexScenarios extends TestCase {

    public void testSubdivideAddMany() {
        QuadTree<Object> tree = QuadTreeFactory.make(0, 0, 100, 100, 2, 3);
        set(tree, 0, 0, "P1");
        set(tree, 1, 2, "P2");
        set(tree, 3, 2, "P3");
    ...
    public void testDimension() {
        QuadTree<Object> tree = QuadTreeFactory.make(1000, 100000, 9000, 900000);
    ...
    public void testSuperslim() {
        QuadTree<Object> tree = QuadTreeFactory.make(0, 0, 100, 100, 1, 100);
        set(tree, 10, 90, "P1");
        set(tree, 10, 95, "P2");
        QuadTreeNodeLeaf<Object> ne = navigateLeaf(tree, "sw,sw,sw,ne");
        compare(10, 90, "P1", (XYPointWValue) ne.getPoints());
        QuadTreeNodeLeaf<Object> se = navigateLeaf(tree, "sw,sw,sw,se");
        compare(10, 95, "P2", (XYPointWValue) se.getPoints());
    }

    public void testSubdivideMultiChild() {
        QuadTree<Object> tree = QuadTreeFactory.make(0, 0, 100, 100, 4, 3);
        set(tree, 60, 11, "P1");
        set(tree, 60, 40, "P2");
        set(tree, 70, 30, "P3");
        set(tree, 60, 10, "P4");
        ...
        QuadTreeNodeBranch<Object> ne = navigateBranch(tree, "ne");
        assertEquals(2, ne.getLevel());

        QuadTreeNodeLeaf<Object> nw = navigateLeaf(ne, "nw");
        ...
        QuadTreeNodeLeaf<Object> se = navigateLeaf(ne, "se");
        compare(90, 45, "P5", (XYPointWValue) se.getPoints());
        assertEquals(1, se.getCount());

        QuadTreeNodeLeaf<Object> sw = navigateLeaf(ne, "sw");
        ...
        QuadTreeNodeLeaf<Object> root = navigateLeaf(tree, "");
    ...
    public void testRemoveNonExistent() {
        QuadTree<Object> tree = QuadTreeFactory.make(0, 0, 100, 100, 20, 20);
        delete(tree, 10, 61);
        set(tree, 10, 60, "P1");
        delete(tree, 10, 61);
        set(tree, 10, 80, "P2");
    ...
    public void testSubdivideSingleMerge() {
        QuadTree<Object> tree = QuadTreeFactory.make(0, 0, 100, 100, 3, 2);
        set(tree, 65, 75, "P1");
        set(tree, 81, 60, "P2");
        set(tree, 80, 60, "P3");
        set(tree, 80, 61, "P4");
        ...
        assertFalse(tree.getRoot() instanceof QuadTreeNodeLeaf);
    ...
    public void testSubdivideMerge() {
        ...
        set(tree, 10, 9.9, "P5");
        set(tree, 9.9, 10, "P6");
        assertTrue(tree.getRoot() instanceof QuadTreeNodeLeaf);
