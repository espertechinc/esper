...
public class TestResultSetProcessorFactory extends TestCase
{
    ...
    public void testGetProcessorNoProcessorRequired() throws Exception
    {
        ...
        ResultSetProcessorFactoryDesc processor = ResultSetProcessorFactoryFactory.getProcessorPrototype(spec, stmtContext, typeService1Stream, null, new boolean[0], true, ContextPropertyRegistryImpl.EMPTY_REGISTRY, null, new Configuration(), null, false);
    ...
    public void testGetProcessorSimpleSelect() throws Exception
    {
        ...
        SelectClauseElementCompiled[] wildcardSelect = new SelectClauseElementCompiled[] {new SelectClauseElementWildcard()};
        StatementSpecCompiled spec = makeSpec(new SelectClauseSpecCompiled(wildcardSelect, false), null, groupByList, null, null, orderByList);
        ResultSetProcessorFactoryDesc processor = ResultSetProcessorFactoryFactory.getProcessorPrototype(spec, stmtContext, typeService3Stream, null, new boolean[0], true, ContextPropertyRegistryImpl.EMPTY_REGISTRY, null, new Configuration(), null, false);
        assertTrue(processor.getResultSetProcessorFactory() instanceof ResultSetProcessorHandThroughFactory);
        ...
        processor = ResultSetProcessorFactoryFactory.getProcessorPrototype(spec, stmtContext, typeService1Stream, null, new boolean[0], true, ContextPropertyRegistryImpl.EMPTY_REGISTRY, null, new Configuration(), null, false);
        assertTrue(processor.getResultSetProcessorFactory() instanceof ResultSetProcessorHandThroughFactory);
    ...
    public void testGetProcessorInvalid() throws Exception
    {
        ...
        try
        {
            ResultSetProcessorFactoryFactory.getProcessorPrototype(spec, stmtContext, typeService3Stream, null, new boolean[0], true, ContextPropertyRegistryImpl.EMPTY_REGISTRY, null, new Configuration(), null, false);
            fail();
        }
