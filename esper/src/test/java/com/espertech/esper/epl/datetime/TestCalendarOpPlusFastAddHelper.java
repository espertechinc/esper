...
public class TestCalendarOpPlusFastAddHelper extends TestCase {
    public void testCompute() {
        long defaultCurrent = DateTime.parseDefaultMSec("2002-05-30T9:51:01.150");

        // millisecond adds
        TimePeriod oneMsec = new TimePeriod().millis(1);
        assertCompute(defaultCurrent, oneMsec, "1980-01-01T0:00:00.000",
                new LongAssertionAtLeast(22 * 365 * 24 * 60 * 60 * 1000L), "2002-05-30T09:51:01.151");
        assertCompute(defaultCurrent, oneMsec, "2001-06-01T0:00:00.000",
                new LongAssertionAtLeast(363 * 24 * 60 * 60 * 1000L), "2002-05-30T09:51:01.151");

        // 10-millisecond adds
        TimePeriod tenMsec = new TimePeriod().millis(10);
        assertCompute(defaultCurrent, tenMsec, "1980-01-01T0:00:00.000",
        ...
        assertCompute(defaultCurrent, hundredMsec, "1980-01-01T0:00:00.000",
