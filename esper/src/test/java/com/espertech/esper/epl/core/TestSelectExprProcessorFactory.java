...
public class TestSelectExprProcessorFactory extends TestCase
{
    ...
    public void testGetProcessorInvalid() throws Exception
    {
        ...
        try
        {
            SelectExprProcessorFactory.getProcessor(Collections.<Integer>emptyList(), selectionList, false, null, null, null,
                    new SupportStreamTypeSvc3Stream(), null, null, null, null, null, null, null, null, null, null, null, null, null, null, new Configuration(), null, null, null, null);
            fail();
        }
    ...
    public void testGetProcessorWildcard() throws Exception
    {
        ...
        SelectExprProcessor processor = SelectExprProcessorFactory.getProcessor(Collections.<Integer>emptyList(), selectionList, false, null, null, null,
                new SupportStreamTypeSvc3Stream(), SupportEventAdapterService.getService(), statementResultService, null, selectExprEventTypeRegistry, null, null, null, new TableServiceImpl(), null, null, null, null, null, null, new Configuration(), null, null, null, null);
    ...
    public void testGetProcessorValid() throws Exception
    {
        ...
        SelectExprProcessor processor = SelectExprProcessorFactory.getProcessor(Collections.<Integer>emptyList(), selectionList, false, null, null, null,
                new SupportStreamTypeSvc3Stream(), SupportEventAdapterService.getService(), statementResultService, null, selectExprEventTypeRegistry, statementContext.getMethodResolutionService(), null, null, null, null, null, null, null, null, null, new Configuration(), null, null, null, null);
