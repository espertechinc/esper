...
public class TestInKeywordQueryPlan extends TestCase implements IndexBackingTableInfo
{
    ...
    public void testSingleIdxSubquery() {
        ...
        assertSubqueryC0C1(3, new Integer[] {100});

        epService.getEPRuntime().sendEvent(new SupportBean_S1(4, "x", "a", "x", "c"));
        assertSubqueryC0C1(4, new Integer[] {100});
    ...
    private void assertSubqueryC0C1(int c0, Integer[] c1) {
