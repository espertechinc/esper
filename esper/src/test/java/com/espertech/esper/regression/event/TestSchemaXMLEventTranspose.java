...
public class TestSchemaXMLEventTranspose extends TestCase
{
    ...
    public void testXPathConfigured() throws Exception
    {
        ...
        EPStatement stmtInsert = epService.getEPAdministrator().createEPL("insert into Nested3Stream select nested1simple, nested4array from MyXMLEvent.std:lastevent()");
        EPStatement stmtWildcard = epService.getEPAdministrator().createEPL("select * from MyXMLEvent.std:lastevent()");
    ...
    public void testExpressionSimpleDOMGetter() throws Exception
    {
        ...
        EPStatement stmtInsert = epService.getEPAdministrator().createEPL("insert into MyNestedStream select nested1 from TestXMLSchemaType.std:lastevent()");
        EPAssertionUtil.assertEqualsAnyOrder(new Object[]{
                new EventPropertyDescriptor("nested1", Node.class, null, false, false, false, false, true),
        }, stmtInsert.getEventType().getPropertyDescriptors());
        EventTypeAssertionUtil.assertConsistency(stmtInsert.getEventType());

        EPStatement stmtSelect = epService.getEPAdministrator().createEPL("select nested1.attr1 as attr1, nested1.prop1 as prop1, nested1.prop2 as prop2, nested1.nested2.prop3 as prop3, nested1.nested2.prop3[0] as prop3_0, nested1.nested2 as nested2 from MyNestedStream.std:lastevent()");
        EPAssertionUtil.assertEqualsAnyOrder(new Object[]{
                new EventPropertyDescriptor("prop1", String.class, null, false, false, false, false, false),
                new EventPropertyDescriptor("prop2", Boolean.class, null, false, false, false, false, false),
                new EventPropertyDescriptor("attr1", String.class, null, false, false, false, false, false),
        ...
        EPStatement stmtInsertWildcard = epService.getEPAdministrator().createEPL("insert into MyNestedStreamTwo select nested1.* from TestXMLSchemaType.std:lastevent()");
        EPAssertionUtil.assertEqualsAnyOrder(new Object[]{
                new EventPropertyDescriptor("prop1", String.class, null, false, false, false, false, false),
                new EventPropertyDescriptor("prop2", Boolean.class, null, false, false, false, false, false),
                new EventPropertyDescriptor("attr1", String.class, null, false, false, false, false, false),
    ...
    public void testExpressionNodeArray() throws Exception
    {
        ...
        EPStatement stmtInsert = epService.getEPAdministrator().createEPL("select nested3.nested4 as narr from TestXMLSchemaType.std:lastevent()");
        EPAssertionUtil.assertEqualsAnyOrder(new Object[]{
        ...
        EPStatement stmtInsertItem = epService.getEPAdministrator().createEPL("select nested3.nested4[1] as narr from TestXMLSchemaType.std:lastevent()");
        EPAssertionUtil.assertEqualsAnyOrder(new Object[]{
    ...
    public void testExpressionPrimitiveArray() throws Exception
    {
        ...
        EPStatement stmtInsert = epService.getEPAdministrator().createEPL("select * from TestNested2.std:lastevent()");
        ...
        EPStatement stmtSelect = epService.getEPAdministrator().createEPL("select nested3.* from ABCType.std:lastevent()");
        SupportXML.sendDefaultEvent(epService.getEPRuntime(), "test");
