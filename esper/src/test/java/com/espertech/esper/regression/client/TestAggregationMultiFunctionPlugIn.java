...
public class TestAggregationMultiFunctionPlugIn extends TestCase
{
    ...
    {
        String epl = "select se1() as c0, se2() as c1 from SupportBean.win:keepall() group by theString";
    ...
    public void testInvalid() {
        ...
        try {
            ConfigurationPlugInAggregationMultiFunction configTwo = new ConfigurationPlugInAggregationMultiFunction("xyz,gmbh,thefunction".split(","), TestAggregationFunctionPlugIn.class.getName());
