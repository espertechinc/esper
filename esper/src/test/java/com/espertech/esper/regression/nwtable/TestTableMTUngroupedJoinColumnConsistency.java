...
public class TestTableMTUngroupedJoinColumnConsistency extends TestCase
{
    private static final Logger log = LoggerFactory.getLogger(TestTableMTUngroupedJoinColumnConsistency.class);
    ...
    public static class Update_1_2_WriteRunnable implements Runnable {
