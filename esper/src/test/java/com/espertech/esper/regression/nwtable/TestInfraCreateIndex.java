...
public class TestInfraCreateIndex extends TestCase
{
    ...
    private void runAssertionOnSelectReUse(boolean namedWindow)
    {
        ...
        epService.getEPAdministrator().createEPL("create window MyInfraTwo.win:keepall() as SupportBean");
    ...
    private void runAssertionIndexReferences(boolean isNamedWindow) {
        ...
        epService.getEPAdministrator().createEPL("@name('join') select col0 from MyInfra, SupportBean_S1.std:lastevent() where col0 = p10");
