...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:d="http://docbook.org/ns/docbook"
  ...
  <xsl:param name="docHref" select="'http://www.espertech.com/esper/documentation.php'"/>
  <xsl:param name="siteLinkText" select="'www.espertech.com'"/>
...
them using CSS so that they all appear in a column on the right. -->
  ...
  <xsl:param name="html.stylesheet" select="'css/espertech.css'"/>
    ...
    <xsl:choose>
      <xsl:when test="$use.simplified.author.group = 1">
        <div class="authorgroup">
          ...
          <div class="others">
            <xsl:call-template name="person.name.list">
              <xsl:with-param name="person.list" select="./d:othercredit"/>
