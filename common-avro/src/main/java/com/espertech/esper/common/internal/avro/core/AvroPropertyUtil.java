...
public class AvroPropertyUtil {
    ...
    protected static EventPropertyGetterSPI getGetter(Schema avroSchema, String moduleName, HashMap<String, EventPropertyGetterSPI> propertyGetterCache, Map<String, PropertySetDescriptorItem> propertyDescriptors, String propertyName, boolean addToCache, EventBeanTypedEventFactory eventAdapterService, EventTypeAvroHandler eventTypeAvroHandler, AvroEventTypeFragmentTypeCache fragmentTypeCache) {
        ...
        if (index == -1) {
            ...
            if (prop instanceof IndexedProperty) {
                ...
                FragmentEventType fragmentEventType = AvroFragmentTypeUtil.getFragmentEventTypeForField(field.schema(), moduleName, eventAdapterService, eventTypeAvroHandler, fragmentTypeCache);
        ...
        String propertyTop = StringValue.unescapeDot(propertyName.substring(0, index));
        ...
        if (fieldTop != null && fieldTop.schema().getType() == Schema.Type.RECORD && propTop instanceof SimpleProperty) {
            ...
            getter = propertyGetterNested(factory, fieldTop.schema(), property, moduleName, eventAdapterService, eventTypeAvroHandler, fragmentTypeCache);
            mayAddToGetterCache(propertyName, propertyGetterCache, getter, addToCache);
            return getter;
        }
        ...
        if (fieldTop != null && fieldTop.schema().getType() == Schema.Type.ARRAY && propTop instanceof IndexedProperty) {
            ...
            Property property = PropertyParser.parseAndWalk(propertyNested, isRootedDynamic);
            getter = propertyGetterNested(factory, fieldTop.schema().getElementType(), property, moduleName, eventAdapterService, eventTypeAvroHandler, fragmentTypeCache);
            mayAddToGetterCache(propertyName, propertyGetterCache, getter, addToCache);
            return getter;
        }
    ...
    private static EventPropertyGetterSPI propertyGetterNested(GetterNestedFactory factory, Schema fieldSchema, Property property, String moduleName, EventBeanTypedEventFactory eventAdapterService, EventTypeAvroHandler eventTypeAvroHandler, AvroEventTypeFragmentTypeCache fragmentTypeCache) {
        ...
        for (Property levelProperty : nested.getProperties()) {
            ...
            if (levelProperty instanceof SimpleProperty) {
                ...
                FragmentEventType fragmentEventType = AvroFragmentTypeUtil.getFragmentEventTypeForField(fieldIndexed.schema(), moduleName, eventAdapterService, eventTypeAvroHandler, fragmentTypeCache);
    ...
    private static class GetterNestedFactoryRootedSimple implements GetterNestedFactory {
        ...
        public GetterNestedFactoryRootedSimple(EventBeanTypedEventFactory eventAdapterService, int posTop) {
    ...
    private static class GetterNestedFactoryRootedIndexed implements GetterNestedFactory {
        ...
        public GetterNestedFactoryRootedIndexed(EventBeanTypedEventFactory eventAdapterService, int pos, int index) {
            this.eventAdapterService = eventAdapterService;
            this.pos = pos;
            this.index = index;
        }
