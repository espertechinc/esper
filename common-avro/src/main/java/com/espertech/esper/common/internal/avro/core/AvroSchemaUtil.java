...
public class AvroSchemaUtil {
    ...
    public static void assembleField(String propertyName, Object propertyType, SchemaBuilder.FieldAssembler<Schema> assembler, Annotation[] annotations, ConfigurationCommonEventTypeMeta.AvroSettings avroSettings, EventTypeNameResolver eventTypeNameResolver, String statementName, TypeRepresentationMapper optionalMapper) {
        ...
        if (propertyType == null) {
            ...
            if (eventType instanceof AvroEventType) {
                ...
                Schema nestedSchema = assembleNestedSchema(mapEventType, avroSettings, annotations, eventTypeNameResolver, statementName, optionalMapper);
    ...
    private static Schema assembleNestedSchema(MapEventType mapEventType, ConfigurationCommonEventTypeMeta.AvroSettings avroSettings, Annotation[] annotations, EventTypeNameResolver eventTypeNameResolver, String statementName, TypeRepresentationMapper optionalMapper) {
        ...
        for (Map.Entry<String, Object> prop : mapEventType.getTypes().entrySet()) {
            AvroSchemaUtil.assembleField(prop.getKey(), prop.getValue(), assembler, annotations, avroSettings, eventTypeNameResolver, statementName, optionalMapper);
        }
