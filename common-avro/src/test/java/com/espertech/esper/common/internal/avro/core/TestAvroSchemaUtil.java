...
public class TestAvroSchemaUtil extends TestCase {
    private final static EventTypeNameResolver EVENT_ADAPTER_SERVICE = new EventTypeNameResolver() {
    ...
    public void testAssemble() {
        ConfigurationCommonEventTypeMeta.AvroSettings defaults = new ConfigurationCommonEventTypeMeta.AvroSettings();
        ConfigurationCommonEventTypeMeta.AvroSettings disableNativeString = new ConfigurationCommonEventTypeMeta.AvroSettings();
        disableNativeString.setEnableNativeString(false);
        ConfigurationCommonEventTypeMeta.AvroSettings disableRequired = new ConfigurationCommonEventTypeMeta.AvroSettings();
    ...
    private void assertTypeArray(Class componentType, Schema.Type expectedElementType, boolean unionOfNull, boolean unionOfNullElements, ConfigurationCommonEventTypeMeta.AvroSettings avroSettings) {
    ...
    private void assertType(Class clazz, Schema.Type expected, boolean unionOfNull, ConfigurationCommonEventTypeMeta.AvroSettings avroSettings) {
    ...
    private void assertStringNative(Schema elementType, ConfigurationCommonEventTypeMeta.AvroSettings avroSettings) {
