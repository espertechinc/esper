...
public class TestSuiteInfraNWTable extends TestCase {
    ...
    public void testInfraNWTableFAFInsertMultirow() {
        RegressionRunner.run(session, InfraNWTableFAFInsertMultirow.executions());
    }
    ...
    public void testInfraNWTableCreate() {
        RegressionRunner.run(session, InfraNWTableCreate.executions());
    }
